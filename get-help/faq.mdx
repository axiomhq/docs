...
description: "This section explains the most important concepts that allow you to gain a deep unstanding of Axiom."
tags:
...
There different ways you can start using Axiom.
...
Axiom’s Personal plan is free forever with a generous allowance. It is available to all customers. All you need to do is [creating an Axiom account](https://app.axiom.co/register).
