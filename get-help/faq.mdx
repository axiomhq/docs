...
query language Axiom use

Axiom Processing Language (APL) is a proprietary query language optimized for timestamped event data. It’s similar to Kusto or SPL, familiar to users of AWS CloudWatch, and more advanced than SQL.

See [Axiom’s documentation on APL](https://axiom.co/docs/apl/introduction)
