...
The`$DATASET_NAME` [dataset](https://axiom.co/docs/reference/datasets) you want to send logs to in Axiom, and the `$API_TOKEN` is your [Axiom API token](https://axiom.co/docs/reference/tokens) for ingesting and quering your Tremor logs.

## Configuration using Syslog

You can also send logs via Tremor to the [Axiom Syslog endpoint](https://axiom.co/docs/endpoints/introduction) using a file as an example data source.
