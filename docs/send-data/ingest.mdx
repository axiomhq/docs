---
title: 'Send Data'
description: "Use Axiom's API to ingest, transport, and retrieve data from different sources such as relational databases, web logs, application logs, and kubernetes."
tags:
