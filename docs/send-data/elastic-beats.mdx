...
You get a `400` if you use the field name `_time` when using the [Elastic Search endpoint](/docs/data-shippers/elastic-beats). Axiom accepts many date strings and timestamps without knowing the format in advance, including Unix Epoch, RFC3339, and ISO 8601.
