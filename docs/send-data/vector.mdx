...
<Frame caption="Vector">
  <img src="/doc-assets/shots/vector-axiom.png" />
</Frame>
...
1. [Create a dataset in Axiom](/docs/reference/settings#data).
2. [Generate an Axiom API token](/docs/reference/settings#access-overview).
...
Replace `your_dataset_name` with the name of the [dataset](https://axiom.co/docs/reference/datasets) you want to send logs to in Axiom, and `your_api_token` with your [Axiom API token](https://axiom.co/docs/reference/settings#api-token).
