...
Replace `your_dataset_name` with the name of the [dataset](/docs/reference/datasets) you want to send logs to in Axiom, and `your_api_token` with your [Axiom API token](/docs/reference/tokens).
