---
title: 'Send Logstash logs to Axiom'
description: 'This step-by-step guide will help you collect, and parse logs from your logstash processing pipeline into Axiom'
tags:
...
- **[Input stage](https://www.elastic.co/guide/en/logstash/8.0/pipeline.html#_inputs):** which generates the event & Ingest Data of all volumes, Sizes, forms, and Sources
