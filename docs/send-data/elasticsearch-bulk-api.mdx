...
Get an Axiom [API token](/docs/reference/tokens) for the Authorization header, and create a [dataset](/docs/reference/datasets).
...
Obtain an Axiom [API token](/docs/reference/tokens) for the Authorization header, and [dataset](/docs/reference/datasets).
