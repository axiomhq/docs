---
title: 'Send logs from Elastic Bulk API '
...
**Note:** The Elasticsearch Bulk API expects the timestamp to be formatted as `@timestamp`, not `_time`. For example:
...
Obtain an Axiom [API token](https://axiom.co/docs/reference/settings#api-token) for the Authorization header, and [dataset](https://axiom.co/docs/reference/settings#dataset).
