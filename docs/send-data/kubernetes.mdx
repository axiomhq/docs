...
- `AXIOM_DATASET_NAME` is your [dataset](/docs/reference/datasets) name.
- `AXIOM_API_TOKEN` is your Axiom API token. To create an API key, see [Access Settings](/docs/reference/settings#access-overview).
