---
title: 'Integrate AWS FireLens with Axiom'
excerpt: 'Leverage AWS FireLens to forward logs from Amazon ECS tasks to Axiom for efficient, real-time analysis and insights.'
tags:
...
- Read more about [Fluent Bit configuration here](/docs/send-data/fluent-bit)
...
```
- Read more about [Fluentd configuration here](/docs/send-data/fluentd)
