---
title: 'Send FluentD logs to Axiom'
excerpt: 'This step-by-step guide will help you collect, aggregate, analyze, and route log files from multiple FluentD sources into Axiom'
tags:
  ['axiom documentation', 'documentation', 'axiom', 'guide', 'logs', 'fluentd', 'metrics', 'http output plugin', 'opensearch output plugin']
---
