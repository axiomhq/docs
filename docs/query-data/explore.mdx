...
![Explore tab overview](/doc-assets/shots/data-explorer-usage-1.png)

Start performing queries on your dataset. A simple query has been performed on the ingested data as shown below.

![Explore tab overview](/doc-assets/shots/simple-query-dashboard-1.png)
...
The Explore tab’s query language is the Axiom Processing Language (APL), a data processing language that supports filtering, extending, and summarizing data. For more information, see [Introduction to APL](/docs/apl/introduction).
...
![Explore tab overview](/doc-assets/shots/apl-count-operator-1.png)
...
![Explore tab overview](/doc-assets/shots/apl-limit-operator-1.png)
...
![Explore tab overview](/doc-assets/shots/apl-summarize-operator-1.png)

### Axiom Processing Language resources

For more resources on APL commands, operators, functions, see [Introduction to APL](/docs/apl/introduction) and the guide on [entity names and identifier naming rules](/docs/apl/entities/entity-names).
