...
![simple time series query builder chart](/doc-assets/shots/timeseries-simple-chart.png)

- Click **Advanced Query Language**.

![simple time series query builder chart](/doc-assets/shots/timeseries-chart-apl.png)
...
![simple time series query builder chart](/doc-assets/shots/area-variant-section-chart.png)
...
![simple time series query builder chart](/doc-assets/shots/bar-variant-chart-1.png)
...
![simple time series query builder chart](/doc-assets/shots/line-variant-section-chart.png)
