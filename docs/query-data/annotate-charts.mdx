...
2. Click <img src="/doc-assets/icons/toggle-annotations.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em" }} alt="Toggle annotations icon" /> **Toggle annotations**.
