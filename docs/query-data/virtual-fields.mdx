...
1. Open the [Datasets](/docs/query-data/datasets) or the [Stream](/docs/query-data/stream) tab.
2. Select the dataset where you want to create the virtual field.
3. Click the <img src="/doc-assets/virtual-fields.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Virtual fields icon" /> **Virtual fields** icon in the top right. You see a list of all the virtual fields for the dataset.
...
Virtual fields are APL expressions and share all the same functions and syntax as APL expressions. For more information, see [Introduction to APL](/docs/apl/introduction).
