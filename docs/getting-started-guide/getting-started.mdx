...
<Card title="Learn how to ingest" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Learn how to stream" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Learn how to analyze" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Explore your data with APL" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Learn how to monitor" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Learn about data shippers" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
...
<Card title="Learn about settings" icon="database" href="/docs/getting-started-guide/getting-started"></Card>
