...
<Card title="Learn how to ingest" icon="paper-plane" href="/docs/send-data/ingest"></Card>
...
<Card title="Learn how to stream" icon="server" href="/docs/query-data/stream"></Card>
...
<Card title="Learn how to analyze" icon="screencast" href="/docs/query-data/datasets"></Card>
...
<Card title="Explore your data with APL" icon="chart-column" href="/docs/apl/introduction"></Card>
...
<Card title="Learn how to monitor" icon="desktop" href="/docs/monitor-data/monitors"></Card>
...
<Card title="Learn about data shippers" icon="ship" href="/docs/send-data/ingest#data-shippers"></Card>
...
<Card title="Learn about settings" icon="gear" href="/docs/reference/settings"></Card>
