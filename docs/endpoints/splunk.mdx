...
excerpt: 'Integrate Axiom in your existing Splunk app with minimal effort and without breaking any of your existing Splunk stack.'
...
- **url/host:** The value of your endpoints URL <a style={{ textDecoration: 'none' }} rel="nofollow">`https://opbivdzfdlohfblnw.ingress.axiom.co/collector/event`</a> generated when creating your endpoints.
