...
excerpt: 'Endpoints let you integrate Axiom in your existing services with minimal effort and without breaking any of your existing workflows.'
tags: 
...
**NB: If you’re using our free personal plan, the endpoints are HTTP only. On our [paid plans](/pricing) (team, and enterprise) the endpoints are HTTP + Syslog.**
