---
title: 'Getting Started with APL'
description: 'Explore how to use APL in Axiom Data Explorer to run queries using Tabular Operators, Scalar Functions, and Aggregation Functions.'
...
- Ingest data into your dataset or you can run queries on our [Play Sandbox](/play)
...
![Tutorials Page](/doc-assets/shots/tutorial2.png)
...
```
<RunInPlayGround 
    href="https://play.axiom.co/axiom-play-qf1k/explorer?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D%5Cn%7C%20where%20_time%20%3E%20ago%287d%29%5Cn%7C%20where%20req_duration_ms%20%3E%3D%205%20and%20req_duration_ms%20%3C%206%5Cn%7C%20summarize%20count%28%29%20by%20bin%28_time%2C%201d%29%5Cn%7C%20order%20by%20_time%20desc%22%2C%22queryOptions%22%3A%7B%22quickRange%22%3A%227d%22%7D%7D" 
    target="_blank" 
    rel="noopener noreferrer"
/>
...
<RunInPlayGround 
    href="https://play.axiom.co/axiom-play-qf1k/explorer?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%5Cn%7C%20where%20content_type%20%3D%3D%20%27text%27%5Cn%7C%20project%20start%3D_time%2C%20id%3D%5B%27id%27%5D%22%2C%22queryOptions%22%3A%7B%22quickRange%22%3A%2230d%22%7D%7D" 
    target="_blank" 
    rel="noopener noreferrer"
/>
