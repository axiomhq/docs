...
excerpt: 'Learn how to create calculated columns and append them to the result set.'
tags: 
...
<RunInPlayGround 
    href="https://play.axiom.co/axiom-play-qf1k/explorer?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%5Cn%7C%20extend%20upper_ct%20%3D%20toupper%28content_type%29%22%2C%22queryOptions%22%3A%7B%22quickRange%22%3A%2230d%22%7D%7D" 
    target="_blank" 
