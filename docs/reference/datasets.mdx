...
1. Click <img src="/doc-assets/icons/settings.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Settings icon" /> **Settings > Datasets**.
2. Click **New dataset**.
...
3. Click <img src="/doc-assets/icons/import.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Import icon" /> **Import**.
...
3. Click <img src="/doc-assets/icons/trim.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Trim dataset icon" /> **Trim dataset**.
...
3. Click <img src="/doc-assets/icons/vacuum.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Vacuum fields icon" /> **Vacuum fields**.
...
3. Click <img src="/doc-assets/icons/import.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Delete dataset icon" /> **Delete dataset**.
