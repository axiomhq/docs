---
title: 'Get started with Axiom CLI'
excerpt: 'Learn how to use the Axiom CLI to ingest data, manage authentication state, and configure multiple deployments.'
tags:
...
![Field list](/doc-assets/shots/oneclick-login.gif 'Fields list')

## Tokens

You can generate an ingest and personal token manually in your Axiom user settings.

See [Tokens](/docs/usage/settings) to know more about managing access and authorization.
...
Get deeper insights into your data using [Axiom Processing Language](/docs/apl/introduction)
...
**You can also visit our [Discord community](/discord) to start or join a discussion. We’d love to hear from you!**
