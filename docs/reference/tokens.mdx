...
For more information on how to use tokens in API requests, see [Getting Started with Axiom API](/docs/restapi/introduction).
...
1. Click <img src="/doc-assets/icons/settings.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Settings icon" /> **Settings > API tokens**, and then click **New API token**.
...
1. Click <img src="/doc-assets/icons/settings.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Settings icon" /> **Settings > API tokens**.
...
3. To the right, click <img src="/doc-assets/icons/delete.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Delete icon" /> **Delete**.
...
To authenticate an API request with a PAT, include the Org ID in the requests. For more information, see [Getting Started with Axiom API](/docs/restapi/introduction).

### Create PAT

1. Click <img src="/doc-assets/icons/settings.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Settings icon" /> **Settings > Profile**.
...
3. To the right of the PAT, click <img src="/doc-assets/icons/delete.svg" style={{ display: "inline", maxHeight: "1.3em", margin: "0 0.2em", backgroundColor: "white", padding: "0.1em", borderRadius: "0.2em" }} alt="Delete icon" /> **Delete**.