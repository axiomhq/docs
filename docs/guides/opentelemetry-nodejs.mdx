...
# Send OpenTelemetry data from a TypeScript app to Axiom

OpenTelemetry provides a [unified approach to collecting telemetry data](https://opentelemetry.io/docs/instrumentation/js/) from your Node.js and TypeScript apps. This guide demonstrates how to configure OpenTelemetry in a Node.js app to send telemetry data to Axiom using OpenTelemetry SDK.
...
- **Node.js Application**: Use your own app written in Node.js, or you can start with the provided **`app.ts`** sample.
