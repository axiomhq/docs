...
You can use the API commands with `curl` by providing your [Access Token](/docs/reference/tokens).
...
See [Creating a Dataset](/docs/reference/datasets) to get started.
...
See [Access Tokens](/docs/reference/tokens) for more detail.

## Organization ID

Organization identification is required for you to send requests using [Personal Tokens](/docs/reference/tokens#personal-access-tokens-pat).
