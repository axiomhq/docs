---
title: 'Getting Started with Axiom API'
excerpt: 'Learn how to ingest structured data logs, handle queries, and manage your deployments using the API.'
tags:
...
You can use the API commands with `curl` by providing your [Access Token](/docs/restapi/token).
...
See [Creating a Dataset](/docs/reference/settings#dataset) to get started.
...
See [Access Tokens](/docs/restapi/token) for more detail.

## Organization ID

Organization identification is required for you to send requests using [Personal Tokens](/docs/restapi/token#personal-token).

The `org id` credentials can be obtained on the **Settings** page.

![Axiom](/doc-assets/shots/rest-orgid-1.png)
