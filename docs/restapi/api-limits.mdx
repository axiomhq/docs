---
title: 'Get started with API Limits'
excerpt: 'Learn how to limit the number of calls a user can make over a certain period of time.'
tags:
...
This is to prevent any single user or application from overloading the system,
