...
The only expected headers are the `Authorization: Bearer`, which is your API or personal token. Learn more about [API Token](/docs/reference/tokens) and [Org ID](/docs/restapi/introduction#organization-id).
