...
These examples send an API event to Axiom. Before getting started with Axiom API, you need to create a [Dataset](/docs/reference/datasets) and [API Token](/docs/reference/tokens).
