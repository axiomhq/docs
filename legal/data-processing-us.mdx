---
title: Data processing addendum (US)
description: "Legal agreement governing data processing."
sidebarTitle: Data processing US
---
...
a. Processing in the United States. Customer acknowledges that, as of the Effective Date, Axiom’s primary processing facilities are in the United States. 
...
b. Usage Data. Upon termination of the Agreement, Axiom may retain, use and disclose Usage Data for the purposes set forth above in Section 3.b (Usage Data) of this Schedule 1, subject to the confidentiality obligations set forth in the Agreement. Axiom will anonymize or delete Personal Data contained within Usage Data when Axiom no longer requires it for the purpose set forth in Section 3.b (Usage Data) of this Schedule 1\. 
...
(iv) in Clause 17 (Option 1), the 2021 Standard Contractual Clauses will be governed by Irish law. (v) in Clause 18(b), disputes will be resolved before the courts of Ireland; (vi) In Annex I, Part A: Data Exporter: Customer and authorized Affiliates of Customer.  
...
Data Exporter Role: The Data Exporter’s role is outlined in Section 3 of this Addendum. 
...
Data Importer Role: The Data Importer’s role is outlined in Section 3 of this Addendum. 
