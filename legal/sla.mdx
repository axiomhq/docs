...
| Asiom Service | Monthly Uptime Percentage |
| :---- | :---- |
...
Axiom investigates all reported Issues. Axiom uses commercially reasonable efforts to fix or provide a workaround as set forth in this Service Quality document. If Axiom needs more time to address a Defend, Axiom will escalate internally and keep Customer informed regarding progress.

“Issue” means an incident that investigation reveals is caused by the Axiom Service’s failure to perform materially in accordance with the specifications set forth in the Documentation for such Axiom Service.  An incident will not be classified as a Issue if (a) the relevant Axiom Service is not used for its intended purpose; (b) the incident is caused by Customer’s or a third party’s software or equipment; or (c) the version of the Axiom Service on which the Issue has purportedly occurred is not the most current version of such Axiom Service made available to Customer under the Agreement.
...
| **High** (P2) | Issue results in partial system failures or disruptions to important business processes. | 1 business day | 4 hour (24x7) | Every 4 hours during business hours |
