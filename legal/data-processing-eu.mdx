...
sidebarTitle: Data processing EU
---

This EU Data Processing Addendum (“Addendum”) is incorporated into and forms part of the Axiom Terms of Service or other applicable agreement governing your use of Axiom’s Services (the “Agreement”).

This Addendum is intended to ensure compliance with the European Union General Data Protection Regulation (EU) 2016/679 (“GDPR”), the UK GDPR, the Swiss FADP, and any applicable national laws implementing or supplementing such regulations.

**By accessing or using the Axiom Services, you agree to this Addendum on behalf of yourself and, where applicable, your Affiliates.**
...
a. Processing Location. Customer data is hosted in the eu-central-1 region on AWS, ensuring compliance with European data protection regulations. This data hosting location is managed with the same security measures and protocols as all other Axiom data centers.
...
**This EU Data Processing Addendum is deemed entered into by Customer and Axiom upon Customer’s acceptance of or continued use of the Services and does not require a separate signature.**
...
b. Usage Data: Customer’s authorized users with access to a Axiom account, customers, suppliers and end-users. 
...
(i) UK Standard Contractual Clauses; and (ii) 2021 Standard Contractual Clauses b. “**UK Standard Contractual Clauses**” means: 
...
(vi) In Annex I, Part A: Data Exporter: Customer and authorized Affiliates of Customer.  
