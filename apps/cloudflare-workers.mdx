...
<Frame caption="Add new layer">
  <img src="/assets/shots/cloudflare-datasets.png" alt="Add new layer" />
</Frame>

- The Axiom token will be your API token with ingest and query permissions.

<Frame caption="Add new layer">
  <img src="/assets/shots/cloudflare-api-token.png" alt="Add new layer" />
</Frame>
...
<Frame caption="Cloudflare worker">
  <img src="/assets/shots/cloudflare-worker-triggers.png" alt="Cloudflare worker" />
</Frame>

- Scroll down to Routes and click Add Route.

<Frame caption="Cloudflare scroll down">
  <img src="/assets/shots/cloudflare-add-routes.png" alt="Cloudflare scroll down" />
</Frame>

- Enter a route, for example,, *.example.com, choose the related zone, then click Save.

<Frame caption="Cloudflare routes">
  <img src="/assets/shots/cloudflare-click-save.png" alt="Cloudflare routes" />
</Frame>
...
<Frame caption="Cloudflare datasets">
  <img src="/assets/shots/cloudflare-datasets-logs.png" alt="Cloudflare datasets" />
</Frame>