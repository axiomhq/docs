...
<Frame caption="Add new layer">
  <img src="/assets/screenshots/cloudflare-datasets.png" alt="Add new layer" />
</Frame>

- The Axiom token will be your API token with ingest and query permissions.

<Frame caption="Add new layer">
  <img src="/assets/screenshots/cloudflare-api-token.png" alt="Add new layer" />
</Frame>
...
<Frame caption="Cloudflare worker">
  <img src="/assets/screenshots/cloudflare-worker-triggers.png" alt="Cloudflare worker" />
</Frame>

- Scroll down to Routes and click Add Route.

<Frame caption="Cloudflare scroll down">
  <img src="/assets/screenshots/cloudflare-add-routes.png" alt="Cloudflare scroll down" />
</Frame>

- Enter a route, for example,, *.example.com, choose the related zone, then click Save.

<Frame caption="Cloudflare routes">
  <img src="/assets/screenshots/cloudflare-click-save.png" alt="Cloudflare routes" />
</Frame>
...
<Frame caption="Cloudflare datasets">
  <img src="/assets/screenshots/cloudflare-datasets-logs.png" alt="Cloudflare datasets" />
</Frame>