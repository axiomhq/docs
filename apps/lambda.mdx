...
<Frame caption="Add new layer">
  <img src="/assets/screenshots/add-new-layer.png" alt="Add new layer" />
</Frame>
...
<Frame caption="Add environment variables">
  <img src="/assets/screenshots/add-env-vars.png" alt="Add environment variables" />
</Frame>
...
<Frame caption="Added environment variables">
  <img src="/assets/screenshots/added-env-vars.png" alt="Added environment variables" />
</Frame>
...
<Frame caption="Disable CloudWatch logging">
  <img src="/assets/screenshots/disable-cw-logs.png" alt="Disable CloudWatch logging" />
</Frame>