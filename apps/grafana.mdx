...
Install the [Axiom Grafana Plugin](https://grafana.com/grafana/plugins/axiomhq-axiom-datasource/) or follow the instructions below:

1. In Grafana, click **Administration > Plugins**.
1. In the filter bar, search for the Axiom plugin.
1. Click **Axiom**.
1. Click **Install**.
...
1. Select the Axiom data source type.
1. Enter the previously generated API token.
...
1. Create a new panel in Grafana by clicking **Add visualization**.
1. Select the Axiom data source.
1. Use the query editor to choose the desired metrics, dimensions, and filters.
...
1. **Rich Querying Capability:** Grafana has a powerful and flexible interface for building data queries. With the Axiom plugin, and leverage this capability to build complex queries against your Axiom data.
1. **Customizable Alerting:** Grafana’s alerting feature allows you to set alerts based on your queries' results, and set up custom alerts based on specific conditions in your Axiom log data.
1. **Sharing and Collaboration:** Grafana’s features for sharing and collaboration can help teams work together more effectively. Share Axiom data visualizations with others, collaborate on dashboards, and discuss insights directly in Grafana.
