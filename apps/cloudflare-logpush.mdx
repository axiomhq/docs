...
<Frame caption="Logpush on zones">
  <img src="/assets/shots/api-token-permissions.png" alt="Logpush on zones" />
</Frame>
...
<Frame caption="Install CloudFlare Logpush App">
  <img src="/assets/shots/axiom-install-cloudflare-logpush.png" alt="Install CloudFlare Logpush App" />
</Frame>

- You see your available accounts and zones. Select the Cloudflare datasets you want to subscribe to.

<Frame caption="Install CloudFlare Logpush App">
  <img src="/assets/shots/cloudflare-datasets-selection.png" alt="Install CloudFlare Logpush App" />
</Frame>
...
<Frame caption="CloudFlare Logpush on zone level">
  <img src="/assets/shots/status-logpush-job-zone-scoped.png" alt="CloudFlare Logpush on zone level" />
</Frame>

For account-scoped Logpush jobs:
<Frame caption="CloudFlare Logpush on account level">
  <img src="/assets/shots/status-logpush-job-account-scoped.png" alt="CloudFlare Logpush on account level" />
</Frame>
...
<Frame caption="CloudFlare Logpush on account level">
  <img src="/assets/shots/realtime-dashboard-performance.png" alt="CloudFlare Logpush on account level" />
</Frame>
...
<Frame caption="CloudFlare Logpush on account level">
  <img src="/assets/shots/acitonable-insights-cloudflare-dashboard.png" alt="CloudFlare Logpush on account level" />
</Frame>
...
<Frame caption="DNS metrics">
  <img src="/assets/shots/dns-metrics-dashboard.png" alt="DNS metrics" />
</Frame>
...
<Frame caption="Centralized logging and error tracing">
  <img src="/assets/shots/centralized-logging-error-tracing.png" alt="Centralized logging and error tracing" />
</Frame>
