...
keywords: ['axiom documentation', 'documentation', 'axiom', 'terraform', 'provision', 'resources', 'cloudwatch', 'aws']
---
...
<Note>
To forward AWS CloudWatch logs to Axiom using Terraform, see the CloudWatch Terraform modules in [Send data from Amazon CloudWatch](/send-data/cloudwatch).
</Note>
