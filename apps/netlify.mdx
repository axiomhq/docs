...
1. Select the log types to send to Axiom.
1. In **Service settings**, enter the following:
    - Full URL: `https://eu-central-1.aws.edge.axiom.co/v1/integrations/netlify/ingest`
    - Authorization Header: `Bearer INTEGRATION_TOKEN`
    Replace `INTEGRATION_TOKEN` with the integration token you copied from Axiom.
1. In **Log Drain Format**, select **JSON**.
1. Click **Connect**.
