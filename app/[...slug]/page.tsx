...
const DOC_ARTICLE_CLASS = 'doc-article min-w-0 w-full';
...
const DOC_TITLE_CLASS = 'm-0 font-sans text-[34px] leading-[42px] font-semibold tracking-[-.03em] text-foreground text-balance';
const QUERY_SYNTAX_TITLE_CLASS = 'query-syntax-title m-0 font-(family-name:--font-query) text-[32px] leading-10 font-semibold tracking-normal text-foreground text-balance [font-variant-ligatures:none]';

// Lede tracks the body text size (--docs-type-size 16px / 1.75); it stays
// distinct through colour and the wider margin, not scale.
const DOC_LEDE_CLASS = 'mt-1.5 mx-0 mb-[34px] max-w-[640px] font-sans text-[16px] leading-7 font-normal tracking-[-.006em] text-secondary-foreground text-pretty';
      ...
      <div className="article-layout min-h-[calc(100svh_-_56px)] px-8 pt-14 pb-24 max-md:px-9 max-sm:px-5 max-sm:pt-9 max-sm:pb-18">
        <div
          className={cn(
            ...
            hasToc && 'xl:max-w-[1026px] xl:grid-cols-[minmax(0,768px)_210px] xl:gap-x-12',
          )}
        ...
        >
          <article className={querySyntaxTitle ? `${DOC_ARTICLE_CLASS} query-syntax-article` : DOC_ARTICLE_CLASS}>
            ...
            <DocsBody className={DOC_PROSE_CLASS}>
