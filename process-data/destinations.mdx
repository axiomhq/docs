...
<Note>
Flow is currently in preview. To try it out, [sign up for a free account](https://forms.axiom.co/flow).
</Note>

To transform and transfer data from an Axiom dataset to a destination, you need to set up a destination. This is where data is transferred. Once you set up a destination, you can use it in any flow.
