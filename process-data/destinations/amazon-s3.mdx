...
3. Configure the following:
    ...
    - In **Region**, select the bucket region. For more information on bucket properties, see the [AWS documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/view-bucket-properties.html).
