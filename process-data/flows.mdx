...
1. In the **Destination** section, click **Add a destination**, and then select the destination where you want to route data. 
1. In the top right, click **Create**.
1. Select one of the following flow types:
