...
- [hash_md5](/apl/scalar-functions/hash-functions/hash-md5): Returns a 32-character MD5 hex digest. MD5 isn't cryptographically safe; use `hash_sha256` for security contexts.
