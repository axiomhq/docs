...
The recommended replacement for the Splunk endpoint is the [Splunk HEC API](/send-data/splunk-hec). For migration steps, see [Migrate Splunk](/endpoints/end-of-life#splunk).
