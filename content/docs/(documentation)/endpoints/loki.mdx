...
The recommended replacement for the Loki endpoint is a log shipper with native Axiom support, such as [Vector](/send-data/vector). For migration options, see [Migrate Loki](/endpoints/end-of-life#loki).
