...
The recommended replacement for the Honeycomb endpoint is [OpenTelemetry](/send-data/opentelemetry). For migration options, see [Migrate Honeycomb](/endpoints/end-of-life#honeycomb).
