...
To get an answer about Axiom from the documentation’s built-in AI assistant, press <kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-border bg-muted px-1.5 align-middle font-mono text-xs leading-none font-medium text-muted-foreground">Cmd/Ctrl</kbd>&nbsp;<kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-border bg-muted px-1.5 align-middle font-mono text-xs leading-none font-medium text-muted-foreground">K</kbd>, and then type your question.
