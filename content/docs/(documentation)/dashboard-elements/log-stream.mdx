...
<Frame>
  <img src="/docs/doc-assets/shots/logstream-simple-query.png" alt="Log stream example with Builder" />
</Frame>
...
<Frame>
  <img src="/docs/doc-assets/shots/log-stream-chart-apl.png" alt="Log stream example with APL" />
</Frame>
