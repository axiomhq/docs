...
keywords: ['aws', 'Firehose documentation', 'documentation', 'Firehose', 'Axiom', 'container logging', 'fluentd', 'fluentbit', 'real-time analysis']
logoId: 'firehose'
---

import AwsDisclaimer from "@/content/snippets/aws-disclaimer.mdx"
