...
Use the HTTP-based destination described earlier on this page instead. It sends data directly to your edge deployment and doesn’t depend on an endpoint.
...
<Frame caption="Cribl LogStream destination configuration">
  <img src="/docs/doc-assets/shots/cribl-output-syslog-1.png" alt="Cribl LogStream destination configuration" />
</Frame>
...
<Frame caption="Configure the Syslog message">
  <img src="/docs/doc-assets/shots/cribl-syslog-message.png" alt="Configure the Syslog message" />
</Frame>
