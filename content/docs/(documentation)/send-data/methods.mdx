...
| [Elixir](/guides/send-logs-from-elixir) | Send logs from Elixir apps with a custom Logger handler |
| [Erlang](/guides/send-logs-from-erlang) | Send logs from Erlang/OTP apps with a custom logger handler |
...
| [Honeycomb](/endpoints/honeycomb) | Legacy endpoint for Honeycomb clients, planned for [end of life](/endpoints/end-of-life). Use OpenTelemetry instead |
...
| [Loki](/endpoints/loki) | Legacy endpoint for Grafana Loki clients, planned for [end of life](/endpoints/end-of-life). Use Vector, Fluent Bit, or the Loki Multiplexer instead |
...
| [PgBouncer](/send-data/pgbouncer) | PgBouncer metrics via pgbouncer_exporter and the OpenTelemetry Collector |
...
| [Secure Syslog](/send-data/secure-syslog) | Legacy TLS syslog endpoint, planned for [end of life](/endpoints/end-of-life). Use Vector or the Syslog Proxy instead |
| [Serverless](/send-data/serverless) | Best practices for serverless environments |
| [Splunk](/endpoints/splunk) | Legacy endpoint for Splunk forwarders, planned for [end of life](/endpoints/end-of-life). Use the Splunk HEC API instead |
