...
| [Honeycomb](/send-data/honeycomb) | Send data from Honeycomb SDKs with OpenTelemetry or the Axiom Honeycomb Proxy |
...
| [Loki](/send-data/loki) | Send data from Loki pipelines and clients |
...
| [Secure Syslog](/send-data/secure-syslog) | Receive syslog over TLS with Vector and forward to Axiom |
| [Serverless](/send-data/serverless) | Best practices for serverless environments |
| [Splunk](/send-data/splunk) | Send data from Splunk forwarders and logging libraries |
