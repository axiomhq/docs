...
import SetUpEndpoint from "@/content/snippets/set-up-endpoint.mdx"
import EndpointsEndOfLifeNotice from "@/content/snippets/endpoints-end-of-life-notice.mdx"

<EndpointsEndOfLifeNotice />

The recommended replacement for the Secure Syslog endpoint is [Vector](/send-data/vector#send-syslog-logs-to-axiom) or the [Axiom Syslog Proxy](/send-data/syslog-proxy). For migration steps, see [Migrate secure syslog](/endpoints/end-of-life#secure-syslog).
