...
[Add Axiom to Cursor](https://cursor.com/en/install-mcp?name=axiom&config=eyJ1cmwiOiJodHRwczovL21jcC5heGlvbS5jby9tY3AifQ%3D%3D).
...
[Add Axiom to VS Code](vscode:mcp/install?%7B%22name%22%3A%22axiom%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A//mcp.axiom.co/mcp%22%7D).
...
For setup and authentication, see the [VS Code MCP documentation](https://code.visualstudio.com/docs/agent-customization/mcp-servers).
...
For setup and authentication, see the [Codex MCP documentation](https://developers.openai.com/codex/mcp/).

</Tab>
<Tab title="ChatGPT">

Follow the [ChatGPT Developer mode guide](https://developers.openai.com/api/docs/guides/developer-mode) to add a remote MCP app with these settings:
...
For setup and authentication, see the [Windsurf MCP documentation](https://docs.windsurf.com/windsurf/cascade/mcp).
...
For setup and authentication, see the [Gemini CLI MCP documentation](https://geminicli.com/docs/tools/mcp-server/) or the [Gemini Code Assist agent mode documentation](https://docs.cloud.google.com/gemini/docs/codeassist/use-agentic-chat-pair-programmer).

</Tab>
<Tab title="Goose">

[Add Axiom to Goose](goose://extension?url=https%3A%2F%2Fmcp.axiom.co%2Fmcp&type=streamable_http&id=axiom&name=Axiom&description=Query%20and%20analyze%20Axiom%20data%20with%20APL%20from%20your%20AI%20agent).

For setup and authentication, see the [Goose extension documentation](https://goose-docs.ai/docs/getting-started/using-extensions/).
...
For setup and authentication, see the [Amp MCP documentation](https://ampcode.com/docs/customize/mcp).
...
For setup and authentication, see the [fx MCP documentation](https://fx.sh/docs/capabilities/mcp).
...
For setup and authentication, see the [OpenCode MCP documentation](https://opencode.ai/docs/mcp-servers).
...
For setup and authentication, see the [Warp MCP documentation](https://docs.warp.dev/agents/capabilities/mcp/).
...
For setup and authentication, see the [Zed MCP documentation](https://zed.dev/docs/ai/mcp).
...
Optional: use the [prebuilt prompts](/console/intelligence/mcp-server/tools#prompts) in clients that support MCP prompts.
