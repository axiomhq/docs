...
<Frame caption="Axiom’s Spotlight feature in action">
  <video autoPlay muted loop playsInline className="w-full" src="/docs/doc-assets/videos/spotlight-feature.mp4"></video>
</Frame>
...
- **Bar charts** for categorical fields (strings, booleans)
    ...
    <Frame caption="Example barchart">
      <img src="/docs/doc-assets/shots/barchart.png" alt="Example barchart" />
    </Frame>
...
- **Boxplots** for numeric fields (integers, floats, timespans) with many distinct values
    ...
    <Frame caption="Example boxplot">
      <img src="/docs/doc-assets/shots/boxplot.png" alt="Example boxplot" />
    </Frame>
