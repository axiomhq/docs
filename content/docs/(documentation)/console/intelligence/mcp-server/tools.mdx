...
<ParamField path="sendFeedback" type="Write">
...
Axiom MCP Server also ships prebuilt prompts for clients that support MCP prompts. Prompts aren’t available with the [local setup](/console/intelligence/mcp-server#local-setup).
