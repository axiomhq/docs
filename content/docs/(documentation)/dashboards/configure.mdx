...
1. In the top right, click <img src="/docs/doc-assets/icons/share.svg" className="my-0 mx-0.5 inline-block size-4 align-text-bottom object-contain dark:invert" alt="Share" /> **Share**.
