...
Except where termination results from fraud or prohibited conduct relating to a referral, Partner remains eligible for Referral Fees on Qualified Leads attributed before the effective date of termination through their applicable Reward Periods. Axiom may withhold or cancel Referral Fees arising from the conduct that gave rise to a suspension or termination, and Partner agrees to reimburse Axiom for any overpaid amounts. Sections 4 through 9 shall survive expiration or termination of this Agreement.
...
This Agreement constitutes the entire agreement between the parties hereto with respect to the subject matter hereof and supersedes all other prior agreements, representations, and statements with respect to such subject matter. Axiom may modify or update this Agreement or the Program Requirements by publishing the updated terms and notifying Partner at the email address associated with Partner’s account. Material changes take effect thirty (30) days after publication, except that changes required by law and changes that benefit Partner may take effect immediately. Changes apply to Qualified Leads attributed on or after their effective date and will not reduce the reward rate or shorten the Reward Period applicable to Qualified Leads attributed before that date. Partner’s continued participation after the effective date of an update constitutes acceptance of the updated terms.
