...
- Click <img src="/docs/doc-assets/icons/fit-to-results.svg" className="my-0 mx-0.5 inline-block size-4 align-text-bottom object-contain dark:invert" alt="Fit panel to results icon" /> **Fit panel to results** or <img src="/docs/doc-assets/icons/fit-to-viewport.svg" className="my-0 mx-0.5 inline-block size-4 align-text-bottom object-contain dark:invert" alt="Fit panel to viewport height icon" /> **Fit panel to viewport height** to change the height of the event details view.
...
1. In the query results view, press <kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-input bg-secondary px-1.5 align-middle font-mono text-xs leading-none font-medium text-secondary-foreground shadow-none!">Cmd/Ctrl</kbd>&nbsp;<kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-input bg-secondary px-1.5 align-middle font-mono text-xs leading-none font-medium text-secondary-foreground shadow-none!">F</kbd>.
...
1. Press <kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-input bg-secondary px-1.5 align-middle font-mono text-xs leading-none font-medium text-secondary-foreground shadow-none!">Enter</kbd> repeatedly to go forward in the list of matches, and press <kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-input bg-secondary px-1.5 align-middle font-mono text-xs leading-none font-medium text-secondary-foreground shadow-none!">Enter</kbd>&nbsp;<kbd className="inline-flex h-5 items-center justify-center rounded-sm border border-input bg-secondary px-1.5 align-middle font-mono text-xs leading-none font-medium text-secondary-foreground shadow-none!">Shift</kbd> to go backward.
