...
<Frame caption="`count` overview">
  <img src="/docs/doc-assets/shots/count.png" alt="`count` overview" />
</Frame>
...
<Frame caption="`distinct` overview">
  <img src="/docs/doc-assets/shots/distinct.png" alt="`distinct` overview" />
</Frame>
...
<Frame caption="`avg` overview">
  <img src="/docs/doc-assets/shots/average.png" alt="`avg` overview" />
</Frame>
...
<Frame caption="max overview">
  <img src="/docs/doc-assets/shots/max.png" alt="max overview" />
</Frame>
...
<Frame caption="`min` overview">
  <img src="/docs/doc-assets/shots/min.png" alt="`min` overview" />
</Frame>
...
<Frame caption="`sum` overview">
  <img src="/docs/doc-assets/shots/sum.png" alt="`sum` overview" />
</Frame>
...
<Frame caption="`percentile` overview">
  <img src="/docs/doc-assets/shots/percentile.png" alt="`percentile` overview" />
</Frame>
...
<Frame caption="`histogram` overview">
  <img src="/docs/doc-assets/shots/histogram.png" alt="`histogram` overview" />
</Frame>
...
<Frame caption="`topk` overview">
  <img src="/docs/doc-assets/shots/topk.png" alt="`topk` overview" />
</Frame>
...
<Frame caption="`variance` overview">
  <img src="/docs/doc-assets/shots/variance.png" alt="`variance` overview" />
</Frame>
...
<Frame caption="`stddev` overview">
  <img src="/docs/doc-assets/shots/stdev.png" alt="`stddev` overview" />
</Frame>
