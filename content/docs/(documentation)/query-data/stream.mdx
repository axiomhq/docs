...
<Frame caption="Datasets overview">
  <img src="/docs/doc-assets/shots/choose-a-dataset-1.png" alt="Datasets overview" />
</Frame>
...
<Frame caption="Event stream">
  <img src="/docs/doc-assets/shots/event-stream-1.png" alt="Event stream" />
</Frame>

You can click an event to be taken to the event details slide-out:

<Frame caption="Event details">
  <img src="/docs/doc-assets/shots/event-slideout-1.png" alt="Event details" />
</Frame>
...
<Frame caption="Event details">
  <img src="/docs/doc-assets/shots/raw-data-1.png" alt="Event details" />
</Frame>
...
<Frame caption="Filter bar">
  <img src="/docs/doc-assets/shots/filtering-1.png" alt="Filter bar" />
</Frame>
...
<Frame caption="Return to Live button">
  <img src="/docs/doc-assets/shots/stream-live-button.gif" alt="Return to Live button" />
</Frame>
...
<Frame caption="View menu">
  <img src="/docs/doc-assets/shots/view-settings-1.png" alt="View menu" />
</Frame>
...
<Frame caption="Saved queries">
  <img src="/docs/doc-assets/shots/stream-starred.png" alt="Saved queries" />
</Frame>
...
1. In the Stream tab, click <Icon icon="gear" iconType="solid"/> in the top right, and then select **Highlight severity**.
