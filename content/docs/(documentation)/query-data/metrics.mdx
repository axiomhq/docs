...
### Try it quickly with axiom-hostmetrics
...
<Frame>
<img src="/docs/doc-assets/shots/hostmetrics.png" alt="axiom-hostmetrics terminal UI showing export latency and live log output" />
</Frame>
...
<Frame caption="OTel metrics dashboard">
  <img src="/docs/doc-assets/shots/otel-metrics-dashboard.png" alt="OTel metrics dashboard" />
</Frame>
...
Axiom accepts up to 256 buckets per histogram data point and up to 256 quantiles per summary data point. Axiom rejects data points that exceed these limits and reports them in the `partial_success` message of the ingest response. For more information, see [Limits on ingested metrics](/reference/limits#limits-on-ingested-metrics).

Axiom doesn’t currently support the following data types:
- Exponential histograms
- `bytes`, `kvlist` tag value types
