...
1. Click <Icon icon="sliders-simple" iconType="light"/> **Toggle annotations**.
...
<Frame caption="Example histogram with annotation">
  <img src="/docs/doc-assets/shots/annotation-chart-example.png" alt="Example histogram with annotation" />
</Frame>
