...
The example below uses [structlog](https://github.com/hynek/structlog) to send logs to Axiom. structlog isn't a dependency of the Axiom Python SDK, so install it separately with `pip install structlog`.
