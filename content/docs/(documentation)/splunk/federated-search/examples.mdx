---
title: 'Federated search examples'
description: 'Copy-paste SPL examples for searching Axiom data from Splunk with federated search, from first searches to lookups and data models.'
sidebarTitle: Examples
keywords: ['splunk', 'federated search examples', 'spl examples', 'stats', 'timechart', 'lookup', 'tstats']
---
...
This is the pattern that makes existing Splunk content work: the lookup table stays in Splunk, the events stay in Axiom, and the join happens where the data is.
