---
title: 'Axiom app for Splunk examples'
description: 'Worked examples for the Axiom app for Splunk, from exploring datasets to enriching Splunk events with Axiom context.'
sidebarTitle: Examples
keywords: ['splunk', 'splunk app examples', 'axsearch', 'axstats', 'axlookup', 'axquery', 'use cases']
---

These examples show common workflows with the Axiom app for Splunk. Each one pushes the expensive part of the search into Axiom, returns a focused result set, and uses normal SPL for presentation. Replace the dataset and field names with your own.
