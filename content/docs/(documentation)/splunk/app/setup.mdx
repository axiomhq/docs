---
title: 'Install and configure the Axiom app for Splunk'
description: 'Learn how to install the Axiom app for Splunk from Splunkbase, connect it to Axiom with an API token, and run your first search.'
sidebarTitle: Install and configure
keywords: ['splunk', 'splunk app', 'splunkbase', 'axsearch', 'axdatasets', 'install', 'api token']
---

The Axiom app for Splunk adds a set of `ax` commands to SPL. With the app, Splunk users discover Axiom datasets, run Axiom-backed searches, push aggregations down into Axiom, look up Axiom context for Splunk events, and keep using normal SPL for the final shaping, dashboards, and alerts.
