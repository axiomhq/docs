...
- A block StorageClass with `volumeMode: Block` support, from which Ceph's OSDs and monitors, PostgreSQL and Valkey claim their volumes; or an external S3-compatible object store in place of Ceph.
