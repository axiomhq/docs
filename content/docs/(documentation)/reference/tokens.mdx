...
sidebarTitle: Tokens
keywords: ['axiom documentation', 'documentation', 'axiom', 'token', 'authenticate']
---
...
1. Optional: Give a description to the API token and set an expiration date.
1. In **Token permissions**, click **Basic**.
1. In **Dataset access**, select the datasets where this token can ingest data.
1. Click **Create**.
...
1. Name your API token.
1. Optional: Give a description to the API token and set an expiration date.
1. In **Token permissions**, click **Advanced**.
1. In **Advanced permissions**, choose one of the following options:
...
1. In the list, select the API token you want to regenerate.
1. Click **Regenerate token**.
1. Copy the regenerated API token that appears and store it securely. It won’t be displayed again.
1. Update all the API requests where you use the API token with the regenerated token.

### Delete API token

1. Click <Icon icon="gear" iconType="solid"/> **Settings > API tokens**.
1. In the list, hold the pointer over the API token you want to delete.
1. To the right, click <Icon icon="trash" iconType="light"/> **Delete**.
...
1. In the **Personal tokens** section, click **New token**.
1. Name the PAT.
1. Optional: Give a description to the PAT.
1. Copy the PAT that appears and store it securely. It wont be displayed again.

### Delete PAT

1. Click <Icon icon="gear" iconType="solid"/> **Settings > Profile**.
1. In the list, find the PAT that you want to delete.
1. To the right of the PAT, click <Icon icon="trash" iconType="light"/> **Delete**.
