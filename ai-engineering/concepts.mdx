...
<Steps>
  ...
  <Step title="Evaluate with ground truth">
    The prototype is then tested against a `collection` of reference examples (`ground truth`) to measure its quality and effectiveness using `graders`. This process is known as an `eval`.
  </Step>
