...
<CardGroup cols={2}>
  <Card title="Axiom AI SDK" icon="bolt" href="/ai-engineering/observe/typescript-sdk">
    **TypeScript** - Use with the Vercel AI SDK for automatic instrumentation with minimal code changes. See the TypeScript SDK guide.
  </Card>
  <Card title="Custom OpenTelemetry" icon="code" href="/ai-engineering/observe/manual-instrumentation">
    **Language-agnostic OpenTelemetry** - Send traces using your own tooling following our semantic conventions. Works with any language or SDK.
  </Card>
</CardGroup>
