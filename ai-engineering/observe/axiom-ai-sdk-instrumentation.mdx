...
1. Install the AI SDK provider for the LLM you want to use. For example, run the following in your terminal to install the OpenAI provider. For the full list of providers, see the [Vercel documentation](https://ai-sdk.dev/providers/ai-sdk-providers).
