...
Choose one of the following options to use a Vercel AI SDK provider for the most common LLMs. For the full list of providers, see the [Vercel documentation](https://ai-sdk.dev/providers/ai-sdk-providers).
