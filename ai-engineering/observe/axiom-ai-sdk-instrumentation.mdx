...
1. Run the following in your terminal to install the Vercel SDK and the OpenAI provider.
...
1. Run the following in your terminal to install the Vercel SDK and the Anthropic provider.
...
1. Run the following in your terminal to install the Vercel SDK and the Gemini provider.
...
1. Run the following in your terminal to install the Vercel SDK and the Grok provider.
