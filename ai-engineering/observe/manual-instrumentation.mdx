...
<Info>
Alternatively, use the Axiom AI SDK for automatic instrumentation. For more information on instrumentation approaches, see [Introduction to Observe](/ai-engineering/observe/introduction).
</Info>
...
- `gen_ai.operation.name` identifies AI spans. It is also a required attribute in the OpenTelemetry specification.
