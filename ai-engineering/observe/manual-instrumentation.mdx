...
<CardGroup cols={2}>
  <Card title="Axiom AI SDK" icon="bolt" href="/ai-engineering/observe/typescript-sdk">
    **Fastest setup** - Use our wrapper around the Vercel AI SDK for automatic instrumentation with minimal code changes.
  </Card>
...
Span names should follow the OpenTelemetry conventions:
