...
description: "Learn how to instrument your TypeScript app with Axiom's AI SDK for automatic AI telemetry capture."
...
This guide shows how to instrument your TypeScript app with Axiom's AI SDK for automatic AI telemetry capture.
...
Using your own OpenTelemetry instrumentation instead? See the [Manual Instrumentation](/ai-engineering/observe/manual-instrumentation) guide for custom OpenTelemetry setup.

Once you're capturing telemetry, return to the [Introduction](/ai-engineering/observe/introduction) to understand how to analyze your AI telemetry data in Axiom's console.
