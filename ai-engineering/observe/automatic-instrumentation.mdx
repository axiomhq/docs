...
description: "Learn how to instrument your TypeScript app with Axiom AI SDK for automatic AI telemetry capture."
keywords: ["ai engineering", "typescript", "axiom ai sdk", "telemetry", "withspan", "opentelemetry"]
---

import { Badge } from "/snippets/badge.jsx"

This page explains how to set up automatic instrumentation in your TypeScript generative AI app using Axiom AI SDK.

Alternatively, instrument your app manually. For more information on instrumentation approaches, see [Introduction to Observe](/ai-engineering/observe/introduction).
...
The initial release of Axiom AI SDK provides deep integration with TypeScript apps, particularly those using Vercel AI SDK to interact with frontier models.
</Info>
...
Axiom AI SDK provides helper functions for popular libraries like Vercel’s [AI SDK](https://ai-sdk.dev/docs) to wrap your existing AI model client.
