...
- [Create an API token in Axiom](/reference/tokens) with permissions to ingest data to the dataset you have created. Axiom recommends scoping the token only to your feedback dataset because it’s exposed in the frontend.
