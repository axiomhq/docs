...
1. Create an APL query about your GenAI dataset. For example:
    ...
    [Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27otel-demo-genai%27%5D%20%7C%20where%20%5B%27attributes.gen_ai.operation.name%27%5D%20%3D%3D%20%22chat%22%22%7D)
