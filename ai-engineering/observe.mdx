...
1. Create an APL query about your gen AI dataset. For example:
...
### Access gen AI dashboard

Axiom automatically creates the gen AI dashboard if the field `attributes.gen_ai.operation.name` is present in your data.

To access the gen AI dashboard:

1. Click the Dashboards tab.
1. Click the dashboard **Generative AI Overview (DATASET_NAME)** where `DATASET_NAME` is the name of your gen AI dataset.

The gen AI dashboard provides you with important insights about your gen AI app such as:
