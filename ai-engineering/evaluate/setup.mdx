---
title: "Set up offline evaluations"
description: "Install the Axiom AI SDK and authenticate with the CLI to run offline evaluations."
...
This page explains how to install Axiom AI SDK and configure your environment for offline evaluations so that your evaluation results are tracked and attributed correctly in the Axiom Console.
...
- The Axiom AI SDK CLI for running offline evaluations

## Authenticate with Axiom AI SDK CLI

The Axiom AI SDK includes a dedicated CLI for running offline evaluations. This CLI is separate from Axiom's main data platform CLI and is focused specifically on AI engineering workflows.
