...
```bash
axiom eval --flag.model=gpt-4o-mini --flag.temperature=0.7
axiom eval --flag.model=gpt-4o-mini --flag.temperature=0.2
axiom eval --flag.model=gpt-4o --flag.temperature=0.7
axiom eval --flag.model=gpt-4o --flag.temperature=0.2
```
