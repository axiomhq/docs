...
<Info>
This page covers handling non-determinism in offline evaluations. In [online evaluations](/ai-engineering/evaluate/online-evaluations), production traffic volume provides natural statistical significance, and you don't need trials because each request is a unique real-world input.
</Info>
