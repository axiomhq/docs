...
<Info>
This page covers flags and experiments in offline evaluations. In [online evaluations](/ai-engineering/evaluate/online-evaluations/setup), you can't use flags because each request is a unique real-world input.
</Info>
