...
<CardGroup cols={2}>
  <Card title="Axiom AI SDK" icon="bolt" href="#installation">
    **Fastest setup** - Use with the Vercel AI SDK for automatic instrumentation with minimal code changes. Follow this guide to get started.
  </Card>
  <Card title="Custom OpenTelemetry" icon="code" href="/ai-engineering/semantic-conventions">
    **Full control** - Send OpenTelemetry traces using your own tooling by following our semantic conventions. Works with any language or SDK.
  </Card>
</CardGroup>
...
* **Continue with Axiom AI SDK**: Learn about instrumenting your AI model and tool calls in the [Observe](/ai-engineering/observe) page.
* **Switch to custom tooling**: If you prefer to use your own instrumentation, see the [Semantic Conventions](/ai-engineering/semantic-conventions) page.
