...
<Info>
`initAxiomAI` is called in your instrumentation file (`/src/instrumentation.ts`). For setup instructions, see [Instrumentation with Axiom AI SDK](/ai-engineering/observe/axiom-ai-sdk-instrumentation).
</Info>
