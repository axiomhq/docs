...
User feedback provides direct signal about which interactions matter most to your customers. The Axiom AI SDK includes lightweight functions to capture both explicit and implicit feedback as timestamped event data:
