...
- `createMonitor`: Create a new monitor using a JSON payload
- `createNotifier`: Create a new notifier using a JSON payload
...
- `updateMonitor`: Update an existing monitor by ID using a full JSON payload
- `updateNotifier`: Update an existing notifier by ID using a full JSON payload
