...
1. Ensure you’re on the Pro, Team, or Enterprise plan. Custom MCP Servers aren’t supported on the Free plan.
...
1. In [Claude.ai](https://claude.ai/settings/connectors) or the [Claude Desktop app](https://claude.ai/download), go to **Settings > Connectors**.
