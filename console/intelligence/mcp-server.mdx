...
For guidance on when to use MCP Server and skills, see [AI agents](/console/intelligence/ai-agents-overview).
...
For the local setup or when using [skills](/console/intelligence/skills), you configure API tokens directly. For detailed guidance on secure token configuration, see [Token hygiene for AI agents](/console/intelligence/ai-agents-overview#token-hygiene-for-ai-agents).
