...
keywords: ["skills", "ai agents", "axiom-sre", "axiom-alerting", "amp", "claude code", "cursor", "sre", "incident response", "dashboards", "cost control", "spl", "apl", "splunk migration", "monitors", "notifiers"]
---
...
<CardGroup cols={2}>
  <Card title="Axiom alerting" icon="bell" href="/console/intelligence/skills/axiom-alerting">
    Create and manage monitors and notifiers via Axiom's v2 public API
  </Card>
