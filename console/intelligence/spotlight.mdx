...
If your organization has [AI features enabled](/organization-settings#turn-axiom-ai-on-or-off), Spotlight will also show an AI-generated summary that helps to interpret these visualizations.
