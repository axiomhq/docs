...
tags: ['aws', 'FireLens documentation', 'documentation', 'FireLens', 'Axiom', 'Amazon ECS', 'container logging', 'fluentd', 'fluentbit', 'real-time analysis']
logoId: 'awsEC2'
---
...
FireLens integrates with your Amazon ECS tasks and services to send logs from your containers to Axiom.
...
Include this within your ECS task definition, and reference the FireLens configuration type and options:
...
The task definition is similar to the Fluent Bit example, but uses Fluentd and its configuration:
...
By routing logs with FireLens and analyzing them with Axiom, businesses and development teams can save on operational overhead and reduce time spent troubleshooting.