...
<Frame caption="Cribl LogStream">
  <img src="/assets/shots/new-destination-cribl1.png" alt="Cribl LogStream" />
</Frame>
...
<Frame caption="Auth overview">
  <img src="/assets/shots/datasets-cribl.png" alt="Auth overview" />
</Frame>
...
<Frame caption="Cribl LogStream destination">
  <img src="/assets/shots/input-endpointurl-cribl-axiom.png" alt="Cribl LogStream destination" />
</Frame>
...
<Frame caption="Cribl LogStream destination headers">
  <img src="/assets/shots/header-http-cribl-axiom.png" alt="Cribl LogStream destination headers" />
</Frame>
...
<Frame caption="Cribl LogStream destination configuration">
  <img src="/assets/shots/cribl-output-syslog-1.png" alt="Cribl LogStream destination configuration" />
</Frame>
...
<Frame caption="Configure the Syslog message">
  <img src="/assets/shots/cribl-syslog-message.png" alt="Configure the Syslog message" />
</Frame>
