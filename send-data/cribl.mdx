...
Open Cribl's UI and navigate to **Destinations > HTTP**. Click **+** Add New to create a new destination.
...
Open Cribl's UI and navigate to **Destinations > Syslog**. Click **+** Add New to create a new destination.
