...
<Frame caption="Cribl LogStream">
  <img src="/assets/screenshots/new-destination-cribl1.png" alt="Cribl LogStream" />
</Frame>
...
<Frame caption="Auth overview">
  <img src="/assets/screenshots/datasets-cribl.png" alt="Auth overview" />
</Frame>
...
<Frame caption="Cribl LogStream destination">
  <img src="/assets/screenshots/input-endpointurl-cribl-axiom.png" alt="Cribl LogStream destination" />
</Frame>
...
<Frame caption="Cribl LogStream destination headers">
  <img src="/assets/screenshots/header-http-cribl-axiom.png" alt="Cribl LogStream destination headers" />
</Frame>
...
<Frame caption="Cribl LogStream destination configuration">
  <img src="/assets/screenshots/cribl-output-syslog-1.png" alt="Cribl LogStream destination configuration" />
</Frame>
...
<Frame caption="Configure the Syslog message">
  <img src="/assets/screenshots/cribl-syslog-message.png" alt="Configure the Syslog message" />
</Frame>
