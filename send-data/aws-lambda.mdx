...
- Axiom Lambda extension: Use the [Axiom Lambda extension](/docs/send-data/aws-lambda) for efficient log collection directly from your Lambda functions. It allows your function to complete its execution quickly while ensuring all logs are reliably sent.
