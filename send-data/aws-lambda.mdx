...
description: 'Explains how to send Lambda function logs and platform events to Axiom.'
sidebarTitle: AWS Lambda
tags:
    ['aws', 'axiom documentation', 'documentation', 'axiom', 'aws lambda', 'axiom lambda extension', 'cloudwatch subscription filters', 'terraform', 'lambda function layer', 'environment variables']
---
