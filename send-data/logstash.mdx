...
For installation instructions for the plugin, check out the [OpenSearch documentation](https://opensearch.org/latest/clients/logstash/index/#install-logstash)
