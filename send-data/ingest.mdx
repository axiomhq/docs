...
2. Using [OpenTelemetry](/send-data/opentelemetry)
3. Using a [Data Shipper](#data-shippers) (Logstash, Filebeat, Metricbeat, Fluentd, etc.)
4. Using the [Elasticsearch Bulk API](/send-data/elasticsearch-bulk-api) that Axiom supports natively
5. Using the [Apps we support](#apps)
6. Using [Endpoints](#endpoints)
