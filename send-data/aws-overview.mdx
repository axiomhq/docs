...
overview: 'Overview of Amazon Web Services cloud computing platform'
sidebarTitle: Overview
tags: ['aws', 'axiom documentation', 'documentation', 'axiom', 'aws cloudfront', 'ADOT', 'amazon s3', 'aws s3', 'aws lambda', 'aws', 'cloudwatch', 'amazon']
logoId: 'aws'
darkLogoId: 'awsdark'
enlargeLogo: true
---
...
- **Service logs**: More than 30 AWS services, including Amazon API Gateway, AWS Lambda, and AWS CloudTrail, can send service logs to CloudWatch.
