...
description: 'Auto-instrument AWS Lambda functions and send telemetry data to Axiom using AWS Distro for OpenTelemetry.'
overview: 'AWS Lambda with OpenTelemetry for serverless tracing'
sidebarTitle: AWS Lambda Using OTel
tags: ['aws', 'otel', 'lambda', 'adot', 'opentelemtry']
