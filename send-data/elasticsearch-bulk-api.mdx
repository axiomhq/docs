...
tags:
    ['elasticsearch', 'axiom documentation', 'documentation', 'axiom', 'elastic bulk api', 'logs', 'metrics']
logoId: 'elastic'
---

import ReplaceDatasetToken from "/snippets/replacement-dataset-token.mdx"
