...
| [Metrics](https://opentelemetry.io/docs/concepts/signals/metrics/) | Private preview      |
...
<Note>
The `/v1/metrics` endpoint only supports the `application/x-protobuf` content type. JSON format is not supported for metrics ingestion.
</Note>
