...
| ------------------------------------------------------------------ | ------------------- |
| [Traces](https://opentelemetry.io/concepts/signals/traces/)   | Yes                 |
| [Logs](https://opentelemetry.io/concepts/signals/logs/)       | Yes                 |
| [Metrics](https://opentelemetry.io/concepts/signals/metrics/) | No (coming soon)    |
