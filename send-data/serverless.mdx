...
Serverless is an open-source framework for building apps on AWS Lambda. Sending event data from your Serverless apps to Axiom allows you to gain deep insights into your apps' performance and behavior without complex setup or configuration.
