...
description: 'This page explains how to send data from AWS CloudWatch to Axiom.'
...
- **Subscriber** runs once to create subscription filters on Forwarder for CloudWatch log groups specified by a combination of names, prefix, and regular expression filters.
...
- **Unsubscriber** runs once to remove subscription filters on Forwarder for CloudWatch log groups specified by a combination of names, prefix, and regular expression filters.
...
1. [Open the Forwarder stack template on Amazon](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=axiom-cloudwatch-forwarder&templateURL=https://axiom-cloudformation.s3.amazonaws.com/stacks/axiom-cloudwatch-forwarder-v1.1.1-cloudformation-stack.yaml). Copy the Forwarder Lambda ARN because it is referenced in the Subscriber stack.
1. [Open the Subscriber stack template on Amazon](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=axiom-cloudwatch-subscriber&templateURL=https://axiom-cloudformation.s3.amazonaws.com/stacks/axiom-cloudwatch-subscriber-v1.1.1-cloudformation-stack.yaml).
1. [Open the Listener stack template on Amazon](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=axiom-cloudwatch-listener&templateURL=https://axiom-cloudformation.s3.amazonaws.com/stacks/axiom-cloudwatch-listener-v1.1.1-cloudformation-stack.yaml).

## Filter CloudWatch log groups
...
To remove subscription filters for one or more log groups, [open the Unsubscriber stack template on Amazon](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=axiom-cloudwatch-subscriber&templateURL=https://axiom-cloudformation.s3.amazonaws.com/stacks/axiom-cloudwatch-unsubscriber-v1.1.1-cloudformation-stack.yaml).
