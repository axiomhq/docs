...
Create a new module for the Forwarder in your Terraform file in the following way:
...
Create a new module for the Subscriber in your Terraform file in the following way:
...
Create a new module for the Listener in your Terraform file in the following way:
...
## Turn off log forwarding

To turn off log forwarding to Axiom, remove subscriptions from the Forwarder with the Unsubscriber module.
