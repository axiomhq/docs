...
The `$DATASET_NAME` is the [dataset](/reference/datasets) you want to send logs to in Axiom, and the `$API_TOKEN` is your [Axiom API token](/reference/tokens) for ingesting and querying your Tremor logs.
