...
description: 'Send data from CloudFront to Axiom using an AWS S3 bucket and Lambda to monitor your static and dynamic content.'
overview: 'Content delivery network service'
sidebarTitle: AWS CloudFront
tags: ['aws', 'axiom documentation', 'documentation', 'axiom', 'aws cloudfront', 'static content', 'dynamic content', 'aws s3', 'aws lambda']
logoId: 'cloudfront'
---
...
Use the Axiom CloudFront Lambda to send CloudFront logs to Axiom using an AWS S3 bucket and Lambda. After you set this up, you can observe your static and dynamic content and run deep queries on your CloudFront distribution logs efficiently.
...
1. In **Standard logging**, select **On**. This enables delivery of your data to your S3 bucket.
1. Click **Create Distribution**, and then click **Run your Distribution**.

Go to Axiom to view your CloudFront distribution logs.