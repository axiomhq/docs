...
Each Axiom organization can create up to 5 Secure Syslog endpoints by default. This is a soft limit that can be increased upon request. [Contact Support](https://axiom.co/contact) to increase the limit for your organization.

For more information on all limits, see [Limits](/reference/limits).
