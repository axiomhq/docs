...
Send data from Google Cloud Platform services to Axiom using OpenTelemetry or Vector.

| Method | Description |
|:--------|:-------------|
| [GCP Overview](/send-data/gcp-overview) | Overview of methods to send GCP data |
| [OpenTelemetry](/send-data/opentelemetry) | Collect GCP metrics and logs via OTel Collector |
| [Vector](/send-data/vector) | Forward Cloud Logging via Pub/Sub |
