...
If you are adding logs to an existing Render project, do so from **Workspace Settings**. Render's documentation for log streams [can be found here](https://docs.render.com/log-streams).

For new appplications:
