...
<Update label="31 July, 2025" tags={["New features"]} rss={{ title: "MCP Server", description: "Bring even more context from Axiom into your LLM clients with four new MCP tools." }}>
