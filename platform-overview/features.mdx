...
| **MetricsDB** | Ingest | [OpenTelemetry Metrics](/send-data/opentelemetry) | Native support for OpenTelemetry metrics protocol. |
| **MetricsDB** | Storage | High-cardinality native | Store metrics with high-cardinality dimensional tags (customer IDs, trace IDs, container names) without performance degradation. |
