...
| **MetricsDB** | Query | [MPL-powered queries](/query-data/metrics/query-metrics) | Query metrics using Metrics Processing Language (MPL) with support for time-series aggregations, dimensional filtering, and cross-metric correlations. |
|  |  |  |  |
