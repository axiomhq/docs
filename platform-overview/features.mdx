...
keywords: ["capabilities", "features", "components", "eventdb", "console", "integrations", "api", "security", "compliance", "intelligence", "spotlight", "llm observability", "genai"]
mode: "wide"
---
...
| **Intelligence** | LLM observability | [GenAI dashboard and traces](/ai-engineering/observe) | Auto-provisioned GenAI dashboard and waterfall trace view for any dataset containing AI telemetry. Instrument using OpenTelemetry or the Axiom AI SDK. |
| | | | |
