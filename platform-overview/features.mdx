...
| **Integrations** | Popular connectors | [Cribl](/send-data/cribl), [Fluent Bit](/send-data/fluent-bit), [Vector](/send-data/vector), [OpenTelemetry](/send-data/opentelemetry), [Syslog](/send-data/syslog-proxy) | Common shippers and pipeline tools for bridging data sources to Axiom. |
