---
title: 'Security'
description: 'This page summarizes what Axiom does to ensure the highest standards of information security and data protection.'
keywords: ['axiom documentation', 'documentation', 'axiom', 'security', 'gdpr', 'ccpa', 'ISO 27001', SOC2 Type II']
---
...
SAML-based SSO, role-based access control (RBAC), and full access to the audit log are available as add-ons if you’re on the Axiom Cloud plan, and they’re included by default on the Bring Your Own Cloud plan. For more information on ugrading, see the [Plan page](https://app.axiom.co/settings/plan) in your Axiom settings.
