...
Replace `ORG_ID` with the name of your Axiom organization. For more information, see [Determine organization ID
](/docs/reference/tokens#determine-organization-id)
