...
1. Send the POST request to one of the following:
    - For tabular output, use `https://api.axiom.co/v1/datasets/_apl?format=tabular`. The tabular output
    - For legacy output, use `https://api.axiom.co/v1/datasets/_apl?format=legacy`. The legacy output
