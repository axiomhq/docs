...
<Warning>
Use this endpoint to ingest data into the default edge deployment of your organization. For more information, see [Ingest data](/restapi/ingest) and [Edge deployments](/reference/edge-deployments).
