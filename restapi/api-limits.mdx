...
To check your current usage, go to <Icon icon="gear" iconType="solid"/> **Settings > Usage**. To resolve the issue, wait for the limit to reset or [upgrade your plan](https://axiom.co/pricing). To reduce future query compute usage, see [Optimize usage](/reference/optimize-usage).
