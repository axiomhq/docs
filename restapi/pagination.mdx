...
<ResponseField name="status.minBlockTime" type="string">
  Timestamp of the earliest event in the current page.
</ResponseField>

<ResponseField name="status.maxBlockTime" type="string">
  Timestamp of the latest event in the current page.
</ResponseField>
