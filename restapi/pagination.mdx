...
Axiom recommends timestamp-based pagination. Cursor-based pagination is in public preview and may result in data loss.
...
Cursor-based pagination is in public preview and may result in data loss. Axiom recommends timestamp-based pagination.
