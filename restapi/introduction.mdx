...
All examples in the Axiom API reference use the US domain `https://api.axiom.co`.

If your oprganization uses the EU domain, change the base domain in the examples to `https://api.eu.axiom.co`.