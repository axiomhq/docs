...
You can create and manage API Tokens from **Settings --> API Tokens** on Axiom UI.

See [Access Tokens](/reference/tokens) for more detail.

## Organization ID

You must provide organization identification when sending requests using [Personal Tokens](/reference/tokens#personal-access-tokens-pat).

You can find the `org id` credentials on the **Settings** page.

<Frame caption="Axiom">
  <img src="/doc-assets/shots/rest-orgid-1.png" alt="Axiom" />
</Frame>

You can also find the `org id` in the URL of your Axiom deployment.
