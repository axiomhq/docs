...
All examples in the Axiom API reference use the US domain `https://api.axiom.co`. For example, if your organization uses the US domain, send data to Axiom with the URL `https://api.axiom.co/v1/datasets/DATASET_NAME/ingest`.
