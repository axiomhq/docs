...
1. Send the POST request to `https://AXIOM_DOMAIN/v1/ingest/{AXIOM_DATASET}`. Replace `DATASET_NAME` with the name of the Axiom dataset where you want to send data.
