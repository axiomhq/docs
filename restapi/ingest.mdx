...
This page explains how to send data to Axiom via cURL commands in each of these formats, and how to send data with the with the [Axiom Node.js library](#send-data-with-axiom-nodejs).
