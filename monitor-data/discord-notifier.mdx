...
- [Create a Discord notifier with a token](#create-discord-notifier-with-token)
- [Create a Discord notifier with a webhook URL](#create-discord-notifier-with-webhook)

## Create a Discord notifier with a token
...
1. Click **OAuth2 > URL Generator**, select the Bot scope and the Send Messages permission.
1. Open the generated URL to add the bot to your server.
1. Click **User Settings > Advanced**, and enable developer mode.
1. Right-click a channel and click **Copy ID**.
1. Make sure the **Discord Bot** has the proper channel access permissions.
...
1. Click **Discord**.
1. Enter the token you generated and the channel ID.
1. Click **Create**.

## Create a Discord notifier with a webhook
...
1. Enter the webhook URL you generated.
1. Click **Create**.