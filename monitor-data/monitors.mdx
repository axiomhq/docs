...
For more information on configuring an integration in Opsgenie, see the [Opsgenie documentation](https://support.atlassian.com/opsgenie/create-a-default-api-integration/).
