...
<Note>
When you use the [Monitors API](/restapi/endpoints/getMonitors) to list monitors, the API only returns monitors for datasets that your API token has query access to. If the API returns an empty list, ensure your token has query permissions for the datasets used by your monitors.
</Note>
