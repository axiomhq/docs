...
The `js` function is the Go template standard JSON-encoding helper. Use it any time the variable could contain user-generated text, log lines, or other content that might include special characters.
