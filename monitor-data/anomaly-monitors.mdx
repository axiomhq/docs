...
1. Configure the monitor using the following options:
    ...
    - The range is the time range for your query. This is a positive integer number of minutes. A longer time range allows the anomaly monitor to consider a larger number of data points when calculating the expected value.
