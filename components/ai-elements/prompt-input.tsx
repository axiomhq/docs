...
/** Base UI passes a synthetic event with `preventBaseUIHandler`, not a DOM Event. */
...
export type PromptInputProps = Omit<
  ...
  "onSubmit" | "onError"
> & {
  // Applied to the inner InputGroup, so callers can style the bordered shell.
...
// Base UI's PreviewCard.Root has no openDelay/closeDelay (those are Radix props),
...
export const PromptInputTabItem = ({
  ...
  <div
    className={cn(
      "flex items-center gap-2 px-3 py-2 text-xs hover:bg-interactive-hover",
      className
    )}
    {...props}
  />
