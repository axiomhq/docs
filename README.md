...
- Optional: [Vale](https://vale.sh/docs/install) for editorial style checks — run `vale content` locally. CI also runs Vale on the docs changed in a PR and posts the findings as an advisory comment; it never blocks the merge.
