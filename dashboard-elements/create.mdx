...
- [Pie chart](/dashboard-elements/pie-chart)
...
1. In the top right of the dashboard element, click <Icon icon="ellipsis-vertical" iconType="solid"/> **More >** <img src="/doc-assets/icons/pencil.svg" className="inline-icon" alt="Pencil icon" /> **Edit**.
