...
The table dashboard element displays a summary of any attributes from your metrics, logs, or traces in a sortable table format. Each row in the table can represent a different service, host, or other entity, with columns showing various attributes or metrics for that entity.
