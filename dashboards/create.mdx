...
For more flexibility, use an AI coding assistant with the [Build dashboards skill](/console/intelligence/skills/building-dashboards). This approach supports multiple data sources, iterative follow-up prompts, and using screenshots of existing dashboards from other tools as context.
...
1. Click the Dashboards tab.
1. Find the dashboard in the list and right-click it.
