...
<Note>
The Axiom hosted MCP server is located in the US. Querying your data using the Axiom hosted MCP server will lead to query results being routed through US infrastructure.
</Note>
