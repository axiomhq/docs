...
This edge deployment model provides flexibility that isn't possible with separate regional instances. With the multi-region add-on, you can create datasets in different edge deployments while maintaining unified management and billing.
