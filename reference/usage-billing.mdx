...
Your compute credits **cannot** cover the following costs:
- Your pricing plan
- Add-ons
- Storage
...
<Warning>
If your organization reaches the spend limit in a month, Axiom prevents actions that generate further usage costs. For example, you cannot run queries and monitors cannot query your data. This can cause interruptions to your service.
</Warning>
