...
<Warning>
The spending limit takes into account the costs you’re billed for at the end of your billing period. This includes all costs, including the base cost of your plan, usage costs, and the costs of any add-ons you have purchased. If your organization reaches the spend limit in a billing period, Axiom immediately prevents actions that generate further costs. This can cause interruptions to your service.

For example, if you have used up the query compute allowance included in your pricing plan, you can’t run queries and your monitors can’t query your data. At the same time, if you haven’t yet used up the data loading allowance, you can still ingest data, and your data will be stored.
</Warning>
