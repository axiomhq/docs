...
<Note>
To access billing information and billing history, you need Owner role permissions in your Axiom organization. If you can't see the **Billing** option in Settings after upgrading or downgrading your plan, ask an organization Owner to grant you the Owner role or access the billing information for you. For more information, see [Role-Based Access Control](/reference/settings).
</Note>
...
1. Ensure you have Owner role permissions. For more information, see [Role-Based Access Control](/reference/settings).
