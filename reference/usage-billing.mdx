...
The spending limit applies to the following usage-related costs:
- Data loading
- Query compute
- Storage

The spending limit doesn’t apply to the following costs:
- Your pricing plan
- Add-ons

This means that even if you reach your spending limit, add-ons and actions that don’t generate usage costs continue working as usual.

The spending limit only takes into account the usage-related costs you’re billed for at the end of your billing period. For the purposes of determining your spending limit, pre-purchased credits don’t count.

<Warning>
If your organization reaches the spend limit in a billing period, Axiom immediately prevents actions that generate further usage costs. For example, you can’t run queries, you can’t ingest more data, and your monitors can’t query your data. This can cause interruptions to your service.
</Warning>
