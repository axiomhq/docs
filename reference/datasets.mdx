...
Trimming permanently deletes data stored in blocks that are older than a date you specify. Trimming doesn’t delete data that’s older than the specified date but shares a block with newer data.
