...
1. In **Kind**, select one of the following:
    - Select **Events** if you plan to use the dataset for event data that doesn’t follow OpenTelemetry (OTel) conventions.
...
1. In **Region**, select the region where you want to store your data. For more information, see [Regions](/reference/regions).
1. Click **Add**.
