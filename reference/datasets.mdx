...
1. To the right of the sharing link, click <Icon icon="trash" iconType="solid"/> **Delete**.
...
1. Click <Icon icon="gear" iconType="solid"/> **Settings > Datasets and views**.
1. In the list, find the dataset, and then click <img src="/doc-assets/icons/share-dataset.svg" className="inline-icon" alt="Share dataset icon" /> **Share dataset** on the right.
1. In the list, find the organization whose access you want to remove, and then click <Icon icon="trash" iconType="solid"/> **Remove**.
...
1. Click <Icon icon="gear" iconType="solid"/> **Settings > Datasets and views**.
1. In the list, click the shared dataset that you want to remove, and then click <Icon icon="trash" iconType="solid"/> **Remove dataset**.
...
1. Click <Icon icon="gear" iconType="solid"/> **Settings > Datasets and views**.
1. In the list, click the dataset that you want to delete, and then click <Icon icon="trash" iconType="solid"/> **Delete dataset**.
...
1. Click <Icon icon="gear" iconType="solid"/> **Settings > Endpoints**.
1. Find the endpoint in the list, and then click <Icon icon="trash" iconType="solid"/> **Delete endpoint** on the right.