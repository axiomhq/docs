...
If you’re on the Axiom Cloud (Personal) plan, the default data retention period is 30 days and you can only specify a shorter period. For more information, see [Pricing-based limits](/reference/field-restrictions#pricing-based-limits).
