...
1. In **Edge deployment**, select the edge deployment you want to use for this dataset. This option is only available if you have access to multiple edge deployments. For more information, see [Edge deployments](/reference/edge-deployments) and [Manage add-ons](/reference/usage-billing#manage-add-ons).
