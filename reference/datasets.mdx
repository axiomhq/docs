...
Dataset retention determines how long Axiom stores your data. By default, your dataset retention period is defined by your pricing plan. However, you can configure custom retention periods for individual datasets that are shorter than your plan's retention period.

To modify a dataset's retention period, follow these steps:

1. Click <img src="/doc-assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > Datasets**.
2. In the list, click the dataset where you want to modify retention.
3. Click **Edit dataset Retention**.
4. Enter a retention period greater than 0 days.
5. Click **Save**.

<Note>
Custom retention periods can only be shorter than your plan's retention period, not longer. If you need a longer retention period, please [contact Support](https://axiom.co/contact).
</Note>

Once you modify a dataset's retention period, any data older than the new retention period will be automatically deleted. This process cannot be undone, so make sure you've selected the appropriate retention period for your needs.
