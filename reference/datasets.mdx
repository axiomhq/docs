...
1. Click <img src="/assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > Datasets**.
2. Click **New dataset**.
...
3. Click <img src="/assets/icons/import.svg" className="inline-icon" alt="Import icon" /> **Import**.
...
3. Click <img src="/assets/icons/trim.svg" className="inline-icon" alt="Trim dataset icon" /> **Trim dataset**.
...
3. Click <img src="/assets/icons/vacuum.svg" className="inline-icon" alt="Vacuum fields icon" /> **Vacuum fields**.
...
3. Click <img src="/assets/icons/import.svg" className="inline-icon" alt="Delete dataset icon" /> **Delete dataset**.
