...
Axiom applies certain limits and requirements to guarantee good service across the platform. Some of these limits depend on your pricing plan, and some are applied system-wide. This reference article explains all limits and requirements applied by Axiom.
...
The following table summarizes the limits applied to each pricing plan. For more details on pricing and contact information, see the [Axiom pricing page](https://axiom.co/pricing).
...
| Fields per dataset     | 256                         | 1,024                                                                         | Custom     |
...
The following limits are applied to all accounts, regardless of the pricing plan.

### Limits on ingested data

The following table summarizes the limits Axiom applies to each data ingest. These limits are independent of your pricing plan.
