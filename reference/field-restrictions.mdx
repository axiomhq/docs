...
|                                      | Axiom Cloud (Personal)      | Axiom Cloud                         | Bring Your Own Cloud |
|--------------------------------------|-----------------------------|-------------------------------------|----------------|
| Data loading (included ingest)       | 500 GB / month              | 1 TB / month                        | *              |
| Data loading (maximum ingest)        | 500 GB / month              | 50 TB / month                       | *              |
| Query compute (included query-hours) | 10 GB-hours / month         | 100 GB-hours / month                | *              |
| Storage (included)                   | 25 GB                       | 600 GB                              | *              |
...
| Endpoints                            | 1 (Honeycomb, Loki, Splunk) | 5 (Honeycomb, Loki, Splunk, Syslog) | 5 (Honeycomb, Loki, Splunk, Syslog)         |
...
If you’re on the Axiom Cloud plan and you exceed the maximum ingest and query-hours quota outlined above, additional charges apply based on your usage above the quota. For more information, see the [Axiom pricing page](https://axiom.co/pricing).
