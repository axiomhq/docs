...
1. Optional: To log out of a session, find the session in the list, and then click <img src="/doc-assets/icons/delete.svg" className="inline-icon" alt="Delete icon" /> **Delete session** on the right.
