...
You can use the Axiom API and CLI to programmatically ingest data and manage your organisation settings. To prove that these requests come from you, you must include forms of authentication called tokens in your API requests. Axiom offers two types of tokens:
