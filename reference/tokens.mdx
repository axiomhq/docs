...
To get started with the Axiom API, you'll need to obtain API keys. Here's how you can get them:

### Getting Basic API tokens
1. Log in to your Axiom account at [app.axiom.co](https://app.axiom.co)
2. Navigate to **Settings > API tokens**
3. Click **New API token**
4. Choose **Basic** permissions if you only need to ingest data
5. Select the datasets you want this token to access
6. Give your token a meaningful name and optionally set an expiration date
7. Click **Create** to generate your token
8. Copy and securely store your token - it won't be shown again

### Getting Advanced API tokens
1. Access **Settings > API tokens** in your Axiom dashboard
2. Click **New API token**
3. Select **Advanced** permissions
4. Choose specific permissions for:
   - Dataset access and actions
   - Organization-level permissions
5. Name your token and optionally set an expiration date
6. Click **Create**
7. Save your token securely - you won't be able to see it again

### Getting Personal Access Tokens (PATs)
<Note>
Only use PATs when you need full account access. For most use cases, API tokens with limited permissions are recommended.
</Note>

1. Go to **Settings > Profile**
2. Find the **Personal tokens** section
3. Click **New token**
4. Name your token
...
- Use the most restrictive token type that meets your needs
