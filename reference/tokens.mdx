...
1. Click <img src="/assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > API tokens**, and then click **New API token**.
...
1. Click <img src="/assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > API tokens**.
...
3. To the right, click <img src="/assets/icons/delete.svg" className="inline-icon" alt="Delete icon" /> **Delete**.
...
1. Click <img src="/assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > Profile**.
...
3. To the right of the PAT, click <img src="/assets/icons/delete.svg" className="inline-icon" alt="Delete icon" /> **Delete**.