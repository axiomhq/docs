...
The current implementation is useful if you want to ingest data to the EU region but your data can leave the EU region for query execution. If your organization has strict data sovereignty requirements, Axiom recommends waiting for the next phase of the rollout before migrating.
