...
If your organization uses the EU domain, change the base domain in the examples to `https://api.eu.axiom.co`. For example, if your organization uses the EU domain, to send data to Axiom with the URL `https://api.eu.axiom.co/v1/datasets/DATASET_NAME/ingest`.