...
<Note>
Role-based access control (RBAC), Directory Sync, and Single Sign-On (SAML SSO) are available as add-ons if you’re on the Axiom Cloud plan, and they are included by default on the Bring Your Own Cloud plan.
</Note>
