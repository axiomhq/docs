...
Features powered by Axiom AI allow you to get insights from your data quicker. They are turned on by default for most customers.

To turn off Axiom AI:

1. Click <img src="/doc-assets/icons/settings.svg" className="inline-icon" alt="Settings icon" /> **Settings > General**
1. Click **Turn off Axiom AI**.
