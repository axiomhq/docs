...
## Query tracking and cost optimization
...
- **Query source**: Track whether queries originated from monitors, dashboards, or direct queries.
...
The audit log help you optimize performance, manage costs, and debug issues by tracing queries back to their origin.
...
The audit log includes detailed information about query execution, helping you optimize performance and manage costs.
...
<Tip>
[Create a monitor](/docs/monitor-data/monitors) using this query to receive alerts when expensive queries run. Adjust the `query_cost_gbms` threshold based on your organization’s usage patterns.
</Tip>
