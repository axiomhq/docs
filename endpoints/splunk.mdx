...
var payload = {
  // Message can be any type; it doesn't have to be an object
  message: {
    temperature: '70F',
    chickenCount: 500,
  },
...
Note: Configure your Splunk deployment's `port` and `index` values in the following code:
...
func main() {
	...
	err := splunk.Log(
		map[string]interface{}{"msg": "axiom endpoints", "msg2": "endpoints"}
	)
	if err != nil {
        	return err
        }
