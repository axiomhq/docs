...
1. Choose one of the following options:
    ...
    - To the right of the **Start date** and **End date** fields, click <img src="/doc-assets/icons/calendar-days.svg" className="inline-icon" alt="Select date and time" /> **Select date and time** to select specific times.
