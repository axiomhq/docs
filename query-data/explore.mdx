...
sidebarTitle: With Builder
keywords: ["query", "builder", "logs", "traces", "events", "metrics"]
---

Query your data using the visual query builder in Console:
...
1. Define the query:
    ...
    - In **Where**, add filters to narrow down the query results. Restrict the query to a set of series whose tag values match the conditions you specify.
    - In **Transformations**, select the transformations you want to apply to the data.
