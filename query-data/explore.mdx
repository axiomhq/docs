...
You can save and export the query and its results so that you can use it in other contexts.
...
1. Axiom AI generates a descriptive name based the query. Accept it or edit it to fit your needs.
1. Click **Save**.

### Replace a previously saved query
