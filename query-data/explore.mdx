...
- In **Y-Axis**, specify the scale of the Y axis. Select from linear or log scales.

#### Merge charts

When you run a query that produces several charts, Axiom displays the charts separately. For example:
