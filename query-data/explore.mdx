...
1. Run a query.
1. Press <kbd>Cmd/Ctrl</kbd>&nbsp;<kbd>Shift</kbd>&nbsp;<kbd>Enter</kbd> to add the chart to Canvas.
...
- Rename a chart by clicking <Icon icon="ellipsis-vertical" iconType="regular"/> **More >** <Icon icon="pencil" iconType="regular"/> **Rename**.
