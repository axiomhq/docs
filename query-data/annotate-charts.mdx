...
Annotating charts allows you to add context to your charts. For example, use annotations to mark the time of the following:
...
To get information about all datasets in your organization, use the following API request:
