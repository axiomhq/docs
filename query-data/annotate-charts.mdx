...
<Frame caption="Example histogram with annotation">
  <img src="/assets/screenshots/annotation-chart-example.png" alt="Example histogram with annotation" />
</Frame>
...
2. Click <img src="/assets/icons/toggle-annotations.svg" className="inline-icon" alt="Toggle annotations icon" /> **Toggle annotations**.
