...
Events in Axiom are immutable after ingestion. You can’t edit, update, or delete individual events once they’re stored. Virtual fields are the primary way to reshape, enrich, and transform your data without needing to re-ingest it.

With virtual fields, there is no need to do any up-front planning of how to structure or transform your data. Send your data as-is and then use virtual fields to manipulate your data in real time during queries.
