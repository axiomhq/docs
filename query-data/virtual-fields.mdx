...
One of the most powerful features of Axiom is virtual fields. With virtual fields, there is no need to do any up-front planning of how to structure or transform your data. Instead, you can send your data as-is and then use virtual fields to manipulate your data in real time during queries.

The feature is also known as derived fields, but Axiom's virtual fields have unique properties that make them more powerful.

In this guide, you'll learn about virtual fields, their features, how to manage them, and how to get the best results from them.
...
3. Click the <img src="/doc-assets/icons/virtual-fields.svg" className="inline-icon" alt="Virtual fields icon" /> **Virtual fields** icon in the top right. A list of all virtual fields for the dataset appears.
4. Click **Add virtual field**.
5. Fill in the following fields:
    - **Name** and **Description**: Help your team understand what the virtual field is about.
    - **Expression**: The formula applied to every event to calculate the virtual field. The expression produces a result such as a `boolean`, `string`, `number`, or `object`.
...
The power of virtual fields lies in letting you manipulate data on read instead of on write, allowing you to adjust and update virtual fields over time and easily add new ones without worrying about previously indexed data.

## Usage

### Visualizations

Virtual fields are available as parameters to visualizations. Because a virtual field can be any of the supported types, make sure that you use a virtual field that produces the correct type of argument.

### Filters

Virtual fields are available in the filter menu, and all filter options are presented. Make sure that you use a supported filter operation for the type of result your virtual field produces.
...
<Tip>
Virtual fields may reference other virtual fields. The order of the fields is important. Make sure that the referenced field is specified before the field that references it.
</Tip>
