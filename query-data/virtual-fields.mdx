...
1. Select the dataset where you want to create the virtual field.
1. Click <Icon icon="function" iconType="light"/> **Virtual fields** in the top right. You see a list of all the virtual fields for the dataset.
1. Click **Add virtual field**.
...
1. Go to the Datasets tab.
1. Select the dataset containing the virtual field.
1. Click <Icon icon="function" iconType="light"/> **Virtual fields** in the top right.
1. Click the virtual field you want to edit.
1. Change the virtual field.
1. Click **Save virtual field**.
...
1. Select the dataset containing the virtual field.
1. Click <Icon icon="function" iconType="light"/> **Virtual fields** in the top right.
1. Right-click the virtual field you want to delete, and then click **Delete virtual field**.
1. Click **Remove virtual field**.

<Warning>
Removing a virtual field removes it permanently from the dataset. Any queries, dashboards, or monitors that reference this virtual field will no longer work correctly.
</Warning>
