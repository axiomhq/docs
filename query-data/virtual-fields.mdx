...
## Managing virtual fields

### Edit a virtual field

To edit an existing virtual field:

1. Go to the Datasets tab.
2. Select the dataset containing the virtual field.
3. Click the <img src="/doc-assets/icons/virtual-fields.svg" className="inline-icon" alt="Virtual fields icon" /> **Virtual fields** icon in the top right.
4. In the list of virtual fields, find the one you want to edit and click it.
5. Modify the name, description, or expression as needed.
6. Click **Save** to apply your changes.

### Delete a virtual field

To delete a virtual field:

1. Go to the Datasets tab.
2. Select the dataset containing the virtual field.
3. Click the <img src="/doc-assets/icons/virtual-fields.svg" className="inline-icon" alt="Virtual fields icon" /> **Virtual fields** icon in the top right.
4. In the list of virtual fields, find the one you want to delete.
5. Right-click on the virtual field and select **Delete**, or click the <img src="/doc-assets/icons/delete.svg" className="inline-icon" alt="Delete icon" /> **Delete** icon if available.
6. Confirm the deletion when prompted.

<Warning>
Deleting a virtual field removes it permanently from the dataset. Any queries, dashboards, or monitors that reference this virtual field will no longer work correctly.
</Warning>
