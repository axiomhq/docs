...
1. To right of the field, click <img src="/doc-assets/icons/ellipsis-vertical.svg" className="inline-icon" alt="Vertical ellipsis icon" /> **More > Manage field**.
...
TODO the sections below are speculative because the UI is in development
...
1. Select a dataset.
1. Expand the **Saved queries** section on the right.
...
1. Select a dataset.
1. Expand the **Query history** section on the right.
1. Optional: In the top right, select whether to display <img src="/doc-assets/icons/single-user.svg" className="inline-icon" alt="Single user icon" /> your queries or <img src="/doc-assets/icons/many-users.svg" className="inline-icon" alt="Many users icon" /> your team’s queries.
1. Find the query in the list, and then click it to run the query.