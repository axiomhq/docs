...
<Frame caption="Datasets overview">
  <img src="/assets/shots/select-a-dataset.png" alt="Datasets overview" />
</Frame>

Select a dataset from the list of datasets:

<Frame caption="Datasets lists">
  <img src="/assets/shots/select-a-dataset-from-list.png" alt="Datasets lists" />
</Frame>
...
<Frame caption="Dataset overview">
  <img src="/assets/shots/dataset-overview-1.png" alt="Dataset overview" />
</Frame>
...
<Frame caption="Fields list">
  <img src="/assets/shots/quick-chart-1.png" alt="Fields list" />
</Frame>
...
<Frame caption="Virtual fields slide-out">
  <img src="/assets/shots/virtual-fields.png" alt="Virtual fields slide-out" />
</Frame>

Click **Virtual fields** on the toolbar to manage of a dataset’s virtual fields.

<Frame caption="Virtual fields tool button">
  <img src="/assets/shots/starred-datasets-2.png" alt="Virtual fields tool button" />
</Frame>
...
<Frame caption="Starred tool button">
  <img src="/assets/shots/starred-3.png" alt="Starred tool button" />
</Frame>
...
<Frame caption="Query history tool button">
  <img src="/assets/shots/query-history-1.png" alt="Query history tool button" />
</Frame>
...
<Frame caption="Query history slide-out">
  <img src="/assets/shots/query-history.png" alt="Query history slide-out" />
</Frame>
...
<Frame caption="Query builder">
  <img src="/assets/shots/query-builder-time-range.png" alt="Query builder" />
</Frame>
...
<Frame caption="Time range">
  <img src="/assets/shots/time-range-22.png" alt="Time range" />
</Frame>
...
<Frame caption="Time range against menu">
  <img src="/assets/shots/compare-against.png" alt="Time range against menu" />
</Frame>

The results look like this:

<Frame caption="Time range against chart">
  <img src="/assets/shots/time-range-chart-1.png" alt="Time range against chart" />
</Frame>
...
<Frame caption="Time range against chart">
  <img src="/assets/shots/time-range-chart-2.png" alt="Time range against chart" />
</Frame>
...
<Frame caption="Visualizations menu">
  <img src="/assets/shots/visualizations.png" alt="Visualizations menu" />
</Frame>
...
<Frame caption="Visualizations demo">
  <img src="/assets/shots/analyze-visualizations-75.gif" alt="Visualizations demo" />
</Frame>
...
<Frame caption="Filters demo">
  <img src="/assets/shots/analyze-filters-900.gif" alt="Filters demo" />
</Frame>
...
<Frame caption="Group by">
  <img src="/assets/shots/group-by.png" alt="Group by" />
</Frame>
...
<Frame caption="Results view">
  <img src="/assets/shots/results-view-700.png" alt="Results view" />
</Frame>
...
<Frame caption="Dataset view options">
  <img src="/assets/shots/logging-dataset-options.png" alt="Dataset view options" />
</Frame>
...
<Frame caption="Event Timeline">
  <img src="/assets/shots/event-timeline-1.png" alt="Event Timeline" />
</Frame>
...
<Frame caption="Event Timeline run query">
  <img src="/assets/shots/event-timeline-2.png" alt="Event Timeline run query" />
</Frame>
...
<Frame caption="Event Timeline time range focus">
  <img src="/assets/shots/event-timeline-4.gif" alt="Event Timeline time range focus" />
</Frame>
