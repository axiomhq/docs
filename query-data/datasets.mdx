...
1. Select a dataset.
1. Optional: In the top right of the **Saved queries** section, select whether to display <Icon icon="user" iconType="light"/> your queries or <img src="/doc-assets/icons/many-users.svg" className="inline-icon" alt="Many users icon" /> your team’s queries.
