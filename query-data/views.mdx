...
1. Create the query using the [visual query builder](/query-data/explore#create-query-using-visual-query-builder) or the [Axiom Processing Language (APL)](/query-data/explore#create-query-using-apl).
