...
<Frame caption="Dashboard">
  <img src="/assets/shots/dashboards-introduction.png" alt="Dashboard" />
</Frame>
...
1. Click **New Dashboard**, add a name and a description, and then click **Create**.
    ...
    <Frame caption="New dashboard dialog">
        <img src="/assets/shots/dashboards-page-1.png" alt="New dashboard dialog" />
    </Frame>
...
2. Click **+ Add a chart** in the top right corner.
    ...
    <Frame caption="New chart button">
        <img src="/assets/shots/your-first-query-1.png" alt="New chart button" />
    </Frame>
...
3. Choose one of the following:
    ...
    - Click **Simple Query Builder** to create your chart using a visual query builder.
        ...
        <Frame caption="Simple Query Builder">
            <img src="/assets/shots/dashboard-b.png" alt="Simple Query Builder" />
        </Frame>
    ...
    - Click **Advanced Query Language** to create your chart using the Axiom Processing Language (APL). For more information, see [Introduction to APL](/apl/introduction).
        ...
        <Frame caption="Advanced Query Language">
            <img src="/assets/shots/dashboard-a.png" alt="Advanced Query Language" />
        </Frame>
...
<Frame>
  <img src="/assets/shots/timeseries-simple-chart.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/shots/timeseries-chart-apl.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/logstream-simple-query.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/shots/log-stream-chart-apl.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/scatter-chart-simple-1.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/shots/scatter-chart-apl-2.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/simple-chart-statistic-1.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/shots/apl-chart-statistic-2.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/table-chart-simple.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/table-chart-apl.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/area-variant-section-chart.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/bar-variant-chart-1.png" />
</Frame>
...
<Frame>
  <img src="/assets/shots/line-variant-section-chart.png" />
</Frame>
...
<Frame caption="Linear scale">
  <img src="/assets/shots/linear-scale-y-axis-chart.png" alt="Linear scale" />
</Frame>
...
<Frame caption="Log scale">
  <img src="/assets/shots/log-scale-y-axis-chart.png" alt="Log scale" />
</Frame>
...
<Frame caption="New chart button">
  <img src="/assets/shots/dashboard-3.png" alt="New chart button" />
</Frame>
