...
1. Click **New Dashboard**, add a name and a description, and then click **Create**.
    ...
    <Frame caption="New dashboard dialog">
        <img src="/doc-assets/shots/dashboards-page-1.png" alt="New dashboard dialog" />
    </Frame>
...
2. Click **+ Add a chart** in the top right corner.
    ...
    <Frame caption="New chart button">
        <img src="/doc-assets/shots/your-first-query-1.png" alt="New chart button" />
    </Frame>
...
3. Choose one of the following:
    ...
    - Click **Simple Query Builder** to create your chart using a visual query builder.
        ...
        <Frame caption="Simple Query Builder">
            <img src="/doc-assets/shots/dashboard-b.png" alt="Simple Query Builder" />
        </Frame>
    ...
    - Click **Advanced Query Language** to create your chart using the Axiom Processing Language (APL). For more information, see [Introduction to APL](/apl/introduction).
        ...
        <Frame caption="Advanced Query Language">
            <img src="/doc-assets/shots/dashboard-a.png" alt="Advanced Query Language" />
        </Frame>
...
<Frame caption="New chart button">
  <img src="/doc-assets/shots/dashboard-3.png" alt="New chart button" />
</Frame>
...
1. In the toolbar, click <img src="/doc-assets/icons/share.svg" className="inline-icon" alt="Share" /> **Share**.
2. Select one of the following:
    ...
    - Select **Everyone** to make the dashboard public. Everyone in your Axiom organization can access the dashboard.
3. Click **Save**.
