...
<Frame caption="Dashboard">
  <img src="/assets/screenshots/dashboards-introduction.png" alt="Dashboard" />
</Frame>
...
1. Click **New Dashboard**, add a name and a description, and then click **Create**.
    ...
    <Frame caption="New dashboard dialog">
        <img src="/assets/screenshots/dashboards-page-1.png" alt="New dashboard dialog" />
    </Frame>
...
2. Click **+ Add a chart** in the top right corner.
    ...
    <Frame caption="New chart button">
        <img src="/assets/screenshots/your-first-query-1.png" alt="New chart button" />
    </Frame>
...
3. Choose one of the following:
    ...
    - Click **Simple Query Builder** to create your chart using a visual query builder.
        ...
        <Frame caption="Simple Query Builder">
            <img src="/assets/screenshots/dashboard-b.png" alt="Simple Query Builder" />
        </Frame>

    - Click **Advanced Query Language** to create your chart using the Axiom Processing Language (APL). For more information, see [Introduction to APL](/apl/introduction).

        <Frame caption="Advanced Query Language">
            <img src="/assets/screenshots/dashboard-a.png" alt="Advanced Query Language" />
        </Frame>
...
<Frame>
  <img src="/assets/screenshots/timeseries-simple-chart.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/screenshots/timeseries-chart-apl.png" />
</Frame>

## Filter bar

For more information on filter bars, see [Create dashboards with filters](/query-data/filters).
...
<Frame>
  <img src="/assets/screenshots/logstream-simple-query.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/screenshots/log-stream-chart-apl.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/scatter-chart-simple-1.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/screenshots/scatter-chart-apl-2.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/simple-chart-statistic-1.png" />
</Frame>

- Click **Advanced Query Language**.

<Frame>
  <img src="/assets/screenshots/apl-chart-statistic-2.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/table-chart-simple.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/table-chart-apl.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/area-variant-section-chart.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/bar-variant-chart-1.png" />
</Frame>
...
<Frame>
  <img src="/assets/screenshots/line-variant-section-chart.png" />
</Frame>
...
<Frame caption="Linear scale">
  <img src="/assets/screenshots/linear-scale-y-axis-chart.png" alt="Linear scale" />
</Frame>
...
<Frame caption="Log scale">
  <img src="/assets/screenshots/log-scale-y-axis-chart.png" alt="Log scale" />
</Frame>
...
<Frame caption="New chart button">
  <img src="/assets/screenshots/dashboard-3.png" alt="New chart button" />
</Frame>
