...
The APL query below defines a chart where the data displayed depends on your choice in the filter with the ID `dataset_filter`. For example, if you choose **otel-demo-traces** in the filter, the chart only displays data from this dataset.
