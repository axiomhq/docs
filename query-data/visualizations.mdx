...
Visualizations are powerful aggregations of your data that produce insights that are easy to understand and monitor.

With visualizations, you can create and obtain data statistics, group fields, and observe methods in running deployments.

This page introduces you to the visualizations supported by Axiom and some tips on how to best use them.
...
This visualization doesn't take any arguments.
...
The `distinct` visualization counts each distinct occurrence of the distinct field inside the dataset and produces a time series chart.
...
The `variance` aggregation returns the sample variance of the fields in the dataset.
...
The `stddev` aggregation returns the sample standard deviation of the fields in the dataset.
