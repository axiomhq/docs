...
<Frame caption="`count` overview">
  <img src="/assets/shots/count.png" alt="`count` overview" />
</Frame>
...
<Frame caption="`distinct` overview">
  <img src="/assets/shots/distinct.png" alt="`distinct` overview" />
</Frame>
...
<Frame caption="`avg` overview">
  <img src="/assets/shots/average.png" alt="`avg` overview" />
</Frame>
...
<Frame caption="max overview">
  <img src="/assets/shots/max.png" alt="max overview" />
</Frame>
...
<Frame caption="`min` overview">
  <img src="/assets/shots/min.png" alt="`min` overview" />
</Frame>
...
<Frame caption="`sum` overview">
  <img src="/assets/shots/sum.png" alt="`sum` overview" />
</Frame>
...
<Frame caption="`percentile` overview">
  <img src="/assets/shots/percentile.png" alt="`percentile` overview" />
</Frame>
...
<Frame caption="`histogram` overview">
  <img src="/assets/shots/histogram.png" alt="`histogram` overview" />
</Frame>
...
<Frame caption="`topk` overview">
  <img src="/assets/shots/topk.png" alt="`topk` overview" />
</Frame>
...
<Frame caption="`variance` overview">
  <img src="/assets/shots/variance.png" alt="`variance` overview" />
</Frame>
...
<Frame caption="`stddev` overview">
  <img src="/assets/shots/stdev.png" alt="`stddev` overview" />
</Frame>
