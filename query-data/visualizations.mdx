...
<Frame caption="`count` overview">
  <img src="/assets/screenshots/count.png" alt="`count` overview" />
</Frame>
...
<Frame caption="`distinct` overview">
  <img src="/assets/screenshots/distinct.png" alt="`distinct` overview" />
</Frame>
...
<Frame caption="`avg` overview">
  <img src="/assets/screenshots/average.png" alt="`avg` overview" />
</Frame>
...
<Frame caption="max overview">
  <img src="/assets/screenshots/max.png" alt="max overview" />
</Frame>
...
<Frame caption="`min` overview">
  <img src="/assets/screenshots/min.png" alt="`min` overview" />
</Frame>
...
<Frame caption="`sum` overview">
  <img src="/assets/screenshots/sum.png" alt="`sum` overview" />
</Frame>
...
<Frame caption="`percentile` overview">
  <img src="/assets/screenshots/percentile.png" alt="`percentile` overview" />
</Frame>
...
<Frame caption="`histogram` overview">
  <img src="/assets/screenshots/histogram.png" alt="`histogram` overview" />
</Frame>
...
<Frame caption="`topk` overview">
  <img src="/assets/screenshots/topk.png" alt="`topk` overview" />
</Frame>
...
<Frame caption="`variance` overview">
  <img src="/assets/screenshots/variance.png" alt="`variance` overview" />
</Frame>
...
<Frame caption="`stddev` overview">
  <img src="/assets/screenshots/stdev.png" alt="`stddev` overview" />
</Frame>
