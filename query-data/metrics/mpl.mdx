...
| `prom::rate` | Prometheus-style rate calculation. |
...
| bucket by service, endpoint to 5m using histogram

// Compute the 50th and 99th percentiles of request duration
| bucket by service to 1m using interpolate_histogram(0.50, 0.99)
```
