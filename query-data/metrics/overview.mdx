...
- **MPL**: A text-based query language (Metrics Processing Language) for writing expressive queries directly. For more information, see [Query metrics using MPL](/query-data/metrics/query-metrics-mpl) and [Sample queries](/mpl/sample-queries).
    <Info>
