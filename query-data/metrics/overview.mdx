...
If you can instrument your architecture to use the OTel Collector, you should use MetricsDB for storing metrics data. But there are some circumstances when you can still use EventDB for metrics-style workloads:
