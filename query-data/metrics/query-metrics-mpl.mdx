...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%60otel-demo-metrics%60%3A%60go.memory.used%60%5B1h..%5D%20%7C%20where%20service%20%3D%3D%20%5C%22frontend%5C%22%20%7C%20align%20to%205m%20using%20avg%22%7D)
...
Use `filter::` functions to remove data points that don't match a condition. Data points that don't match are removed from the series entirely.
