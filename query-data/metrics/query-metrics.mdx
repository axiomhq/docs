...
To write queries directly using a text-based language, use MPL (Metrics Processing Language). For more information, see [MPL reference](/query-data/metrics/mpl). To migrate existing PromQL queries to Axiom, see [Migrate PromQL queries to Axiom](/query-data/metrics/migrate-metrics).
</Note>
