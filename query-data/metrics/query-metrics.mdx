...
If you use PromQL, your existing expressions can be translated to AxQL for quick onboarding and greater flexibility. For more information, see [Migrate metrics to Axiom](/query-data/metrics/migrate-metrics).
...
{/*
```kusto
| align to <emit window> [over <sliding window>] <aggregation_function>
```
*/}
...
| bucket by project, namespace to 5m using wasm::my_module::my_function
```
*/}
