...
To write queries directly using a text-based language, use MPL (Metrics Processing Language). For more information, see [Query metrics using MPL](/query-data/metrics/query-metrics-mpl).
