...
When the underlying metric is a histogram, Axiom computes `bucket` aggregations using the `interpolate_histogram` function. For quantile aggregations, this estimates the quantile using the underlying histogram data.
</Note>
