...
<Warning>
axiom-hostmetrics is intended for exploration and development. For production systems, use the [OTel Collector with the hostmetrics receiver](/send-data/opentelemetry).
</Warning>
