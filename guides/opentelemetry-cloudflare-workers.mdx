...
<Note>
This guide also applies to web frameworks that run on Cloudflare Workers such as [Hono](https://hono.dev/). Hono apps deployed to Cloudflare Workers can use the same OpenTelemetry configuration described below.
</Note>
