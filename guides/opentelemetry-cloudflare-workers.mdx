...
<Frame caption="View your app in your cloudflare workers dashboard">
  <img src="/assets/shots/view-application-in-cloudflare-workers.png" alt="View your app in your cloudflare workers dashboard" />
</Frame>
...
<Frame caption="Observe the telemetry data in Axiom">
  <img src="/assets/shots/observe-telemetry-data-cloudflare-workers.png" alt="Observe the telemetry data in Axiom" />
</Frame>
...
<Frame caption="Dynamic Opentelemetry traces dashboard">
  <img src="/assets/shots/dynamic-opentelemetry-dashboard.png" alt="Dynamic Opentelemetry traces dashboard" />
</Frame>
