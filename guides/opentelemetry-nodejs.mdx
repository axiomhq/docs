...
<Frame caption="Observing the telemetry data in Axiom">
  <img src="/assets/screenshots/observing-the-node-telemetry-data-in-axiom.png" alt="Observing the telemetry data in Axiom" />
</Frame>
...
<Frame caption="Dynamic OpenTelemetry traces dashboard">
  <img src="/assets/screenshots/dynamic-otel-node-traces-dashbaord.png" alt="Dynamic OpenTelemetry traces dashboard" />
</Frame>
