---
title: "Send data from Flutter app"
description: "This page explains how to send data from Flutter apps to Axiom."
...
1. In Axiom, go to the Stream tab, and then click your dataset. This page displays the logs sent to Axiom and enables you to monitor and analyze your app's behavior and performance.
...
1. Initialize the logger early in your app's lifecycle, typically in your `main()` function.
...
1. Use the logger throughout your app to capture important events, errors, and debug information. For example:
