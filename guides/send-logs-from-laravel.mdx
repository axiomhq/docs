    ...
    'channels' => [
        ...
        'axiom' => [
            ...
            'with' => [
                ...
                'region' => env('AXIOM_REGION', 'us-east-1.aws'), // Default to US region
            ],
        ],
...
class AxiomHandler extends AbstractProcessingHandler
{
    ...
    public function __construct($level = Logger::DEBUG, bool $bubble = true, $apiToken = null, $dataset = null, $region = null)
    {
    ...
    {
        $endpoint = "https://{$this->region}.edge.axiom.co/v1/ingest/{$this->dataset}";
