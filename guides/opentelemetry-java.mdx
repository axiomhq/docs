...
|                                       | scope.name                                    | Instrumentation scope, typically the Java package or app component, e.g., `com.example.DiceRollerApp`. |
| **Service Attributes**                |                                               |             |
|                                       | service.name                                  | Name of the service generating the trace, e.g., `axiom-java-otel`. |
