...
<Frame caption="Observing the Telemetry data in Axiom image">
  <img src="/assets/screenshots/opentelemetry-data-python-axiom.png" alt="Observing the Telemetry data in Axiom image" />
</Frame>
...
<Frame caption="Dynamic OpenTelemetry Traces dashboard">
  <img src="/assets/screenshots/opentelemetry-dashboard-python-traces.png" alt="Dynamic OpenTelemetry Traces dashboard" />
</Frame>
