...
description: 'This guide explains how to send data from a Node.js app to Axiom through Winston.'
...
For further examples, head over to the [examples](https://github.com/axiomhq/axiom-js/tree/main/examples/winston) directory.
