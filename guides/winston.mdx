---
title: 'Axiom transport for the Winston logger'
description: 'This page explains how to send data from a Node.js app to Axiom through the Winston logger.'
overview: 'Winston is a logger for just about everything'
