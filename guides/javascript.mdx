...
While axiom-js works on both the backend and the browsers, We provide transports for some of the popular loggers:

- [Pino](./pino): A Pino transport which sends logs to Axiom.
- [Winston](./winston): A Winston transport which sends logs to Axiom


For further examples, head over to the [examples](https://github.com/axiomhq/axiom-js/tree/main/examples) directory.
