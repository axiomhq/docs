...
Sdk.CreateTracerProviderBuilder()
    ...
    .AddOtlpExporter(options =>
    {
        ...
        // Ensure to replace YOUR_API_TOKEN and DATASET_NAME with your actual API token and dataset name
        options.Headers = $"Authorization=Bearer YOUR_API_TOKEN, X-Axiom-Dataset=DATASET_NAME";
    })
    .Build();
```
