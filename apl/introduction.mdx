...
description: "Use APL to query logs and traces with a text-based query language."
...
Axiom Processing Language (APL) is a text-based query language to query logs and traces. It provides the flexibility to filter, manipulate, and summarize your data exactly the way you need it.

<Info>
You can't use APL to query metrics. For more information, see [Query metrics](/query-data/metrics/overview#query-metrics).
</Info>
