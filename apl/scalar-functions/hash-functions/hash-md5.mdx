...
Hash request URIs to count 404 responses per endpoint without logging sensitive path information.

**Query**

```kusto
['sample-http-logs']
| extend hashed_uri = hash_md5(uri)
| summarize request_count = count() by hashed_uri, status
| where status == '404'
| sort by request_count desc
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%20%7C%20extend%20hashed_uri%20%3D%20hash_md5%28uri%29%20%7C%20summarize%20request_count%20%3D%20count%28%29%20by%20hashed_uri%2C%20status%20%7C%20where%20status%20%3D%3D%20%27404%27%20%7C%20sort%20by%20request_count%20desc%22%7D)

**Output**

| hashed_uri | status | request_count |
| ---------- | ------ | ------------- |
| d41d8cd98f00b204e9800998ecf8427e | 404 | 230 |
| 9e107d9d372bb6826bd81d3542a419d6 | 404 | 145 |
| 7215ee9c7d9dc229d2921a40e899ec5f | 404 | 132 |

The query hides sensitive path information but still lets you identify which endpoints generate the most 404 errors.
