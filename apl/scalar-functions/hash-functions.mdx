...
The MD5 hash value of the given scalar, encoded as a hex string (a string of characters, each two of which represents a single hex number between 0 and 255).
...
The SHA256 hash value of the given scalar, encoded as a hex string (a string of characters, each two of which represents a single hex number between 0 and 255).
...
The SHA512 hash value of the given scalar, encoded as a hex string (a string of characters, each two of which represents a single hex number between 0 and 511).
