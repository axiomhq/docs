...
The `bin()` function is used with the [summarize operator](/apl/tabular-operators/summarize-operator). If your set of values is disorderly, they will be grouped into fractions.
