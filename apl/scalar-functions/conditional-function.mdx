...
| [iff()](#iff) | Evaluates the first argument (the predicate) and returns the value of either the second or third argument. |
...
- result: An expression that Axiom evaluates and returns if its condition is the first to evaluate to true.
- nothingMatchedResult: An expression that Axiom evaluates and returns if none of the conditional expressions evaluates to true.
...
Evaluates the first argument (the predicate) and returns the value of either the second or third argument. The second and third arguments must be of the same type.

### Arguments 

- predicate: An expression that evaluates to a Boolean value.
- ifTrue: An expression that gets evaluated and its value returned if the predicate evaluates to `true`.
- ifFalse: An expression that gets evaluated and its value returned if the predicate evaluates to `false`.

### Returns 

This function returns the value of ifTrue if the predicate evaluates to true, or the value of ifFalse otherwise.
