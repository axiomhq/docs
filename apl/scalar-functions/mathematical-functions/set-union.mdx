...
print result = set_union(array1, array2)
```
...
* [set_intersect](/apl/array-functions/set_intersect): Returns elements common to both arrays. Use this when you want the intersection instead of the union.
* [set_difference](/apl/array-functions/set_difference): Returns elements in the first array that are not in the second. Use it to find exclusions.
* [array_concat](/apl/array-functions/array_concat): Concatenates arrays without removing duplicates. Use this when you want to preserve all values.
* [array_distinct](/apl/array-functions/array_distinct): Removes duplicates from a single array. Use this when working with one array only.
* [set_has_element](/apl/array-functions/set_has_element): Checks if an array contains a specific value. Use this for conditional filtering based on set membership.
