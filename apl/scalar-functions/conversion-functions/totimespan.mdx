...
| extend is_slow = duration_span > totimespan('00:00:01')
| where is_slow == true
| project _time, ['uri'], ['req_duration_ms'], duration_span, is_slow
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D%20%7C%20extend%20duration_span%20%3D%20totimespan(%5B'req_duration_ms'%5D%20*%201000000)%20%7C%20extend%20is_slow%20%3D%20duration_span%20%3E%20totimespan('00%3A00%3A01')%20%7C%20where%20is_slow%20%3D%3D%20true%20%7C%20project%20_time%2C%20%5B'uri'%5D%2C%20%5B'req_duration_ms'%5D%2C%20duration_span%2C%20is_slow%22%7D)
...
| extend is_suspicious_duration = request_duration > totimespan('00:00:05')
| where (['status'] == '403' or ['status'] == '401') and is_suspicious_duration == true
| project _time, ['uri'], ['status'], ['req_duration_ms'], request_duration, is_suspicious_duration
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D%20%7C%20extend%20request_duration%20%3D%20totimespan(%5B'req_duration_ms'%5D%20*%201000000)%20%7C%20extend%20is_suspicious_duration%20%3D%20request_duration%20%3E%20totimespan('00%3A00%3A05')%20%7C%20where%20(%5B'status'%5D%20%3D%3D%20'403'%20or%20%5B'status'%5D%20%3D%3D%20'401')%20and%20is_suspicious_duration%20%3D%3D%20true%20%7C%20project%20_time%2C%20%5B'uri'%5D%2C%20%5B'status'%5D%2C%20%5B'req_duration_ms'%5D%2C%20request_duration%2C%20is_suspicious_duration%22%7D)
