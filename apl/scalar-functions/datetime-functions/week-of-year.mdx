...
[Run in Playground]([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D) %7C extend week%20%3D%20week_of_year(_time) %7C summarize avg(req_duration_ms)%20by%20week %7C sort%20by%20week%20asc%22%7D)
...
[Run in Playground]([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27otel-demo-traces%27%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27otel-demo-traces%27%5D) %7C where%20%5B%27service.name%27%5D%20%3D%3D%20%27frontend%27 %7C extend%20week%20%3D%20week_of_year(_time) %7C summarize%20avg_duration%20%3D%20avg(duration)%20by%20week %7C sort%20by%20week%20asc%22%7D)
...
[Run in Playground]([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D) %7C where%20status%20startswith%20%275%27 %7C extend%20week%20%3D%20week_of_year(_time) %7C summarize%20error_count%20%3D%20count()%20by%20week %7C sort%20by%20week%20asc%22%7D)
...
- [day_of_week](/apl/datetime-functions/day_of_week): Returns the day of the week as a number (Sunday = 0 through Saturday = 6). Use this when you need daily granularity instead of weekly.
- [startofweek](/apl/datetime-functions/startofweek): Returns the start of the week for a given datetime. Use this when you need a consistent anchor date for grouping or filtering.
- [format_datetime](/apl/datetime-functions/format_datetime): Converts a datetime value to a string in a specified format. Useful for labeling weekly groupings.
- [format_timespan](/apl/datetime-functions/format_timespan): Formats a timespan as a string. Useful when working with weekly durations or intervals.
- [datetime_part](/apl/datetime-functions/datetime_part): Extracts a specified part of a datetime value, including year, month, day, and week (non-ISO). Use it for custom calendar calculations.
