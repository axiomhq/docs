...
| project _time, method, decoded_method
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%20%7C%20where%20status%20%3D%3D%20%27200%27%20%7C%20extend%20codepoints%20%3D%20dynamic%28%5B72%2C%2084%2C%2084%2C%2080%5D%29%20%7C%20extend%20decoded_method%20%3D%20unicode_codepoints_to_string%28codepoints%29%20%7C%20project%20_time%2C%20method%2C%20decoded_method%22%7D)

**Output**

| _time               | method | decoded_method |
| -------------------- | ------ | --------------- |
| 2025-07-29T14:12:00Z | GET    | HTTP            |
...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27otel-demo-traces%27%5D%20%7C%20where%20%5B%27service.name%27%5D%20%3D%3D%20%27checkoutservice%27%20%7C%20extend%20trace_label_codepoints%20%3D%20dynamic%28%5B67%2C%2072%2C%2069%2C%2067%2C%206B%5D%29%20%7C%20extend%20decoded_label%20%3D%20unicode_codepoints_to_string%28trace_label_codepoints%29%20%7C%20project%20_time%2C%20trace_id%2C%20%5B%27service.name%27%5D%2C%20decoded_label%22%7D)

**Output**

| _time               | trace_id        | ['service.name'] | decoded_label |
| -------------------- | ---------------- | ----------------- | -------------- |
| 2025-07-29T14:20:00Z | d4e9aefb8cc31b4d | checkoutservice   | CHECK          |
...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%20%7C%20where%20status%20%3D%3D%20%27403%27%20%7C%20extend%20obfuscated_uri%20%3D%20dynamic%28%5B47%2C%20108%2C%20111%2C%20103%2C%20105%2C%20110%5D%29%20%7C%20extend%20decoded_uri%20%3D%20unicode_codepoints_to_string%28obfuscated_uri%29%20%7C%20project%20_time%2C%20uri%2C%20decoded_uri%22%7D)
...
- [string_to_unicode_codepoints](/apl/string-functions/string_to_unicode_codepoints): Converts a UTF-8 string into an array of Unicode code points. Use it when you need the reverse transformation.
- [tostring](/apl/scalar-functions/tostring): Converts values to string but doesn’t interpret Unicode code points. Use it for general-purpose casting.
- [parse_json](/apl/scalar-functions/parse_json): Parses JSON text into a dynamic value. Use it when your Unicode code point data is embedded in a JSON structure.
- [format_string](/apl/string-functions/format_string): Formats strings with placeholders. Use it when you want to assemble strings with embedded values, not decode Unicode arrays.
- [replace_string](/apl/string-functions/replace_string): Replaces parts of a string using regular expressions. Use it when editing text after decoding.
