...
['sample-http-logs']
| extend pattern_count = countof_regex(uri, 'error|warning')
```
</CodeGroup>
...
```kusto APL equivalent
['sample-http-logs']
| extend count = countof_regex(field, 'pattern')
```
</CodeGroup>
...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%20%7C%20extend%20numeric_params%20%3D%20countof_regex(uri%2C%20%27%5B0-9%5D%2B%27)%20%7C%20where%20numeric_params%20%3E%200%20%7C%20summarize%20avg_params%20%3D%20avg(numeric_params)%2C%20request_count%20%3D%20count()%20by%20method%20%7C%20sort%20by%20request_count%20desc%22%7D)
...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B%27sample-http-logs%27%5D%20%7C%20extend%20special_chars%20%3D%20countof_regex(uri%2C%20%27%5B%3C%3E%5C%27%5C%22%25%3B()%26%2B%5D%27)%20%7C%20where%20special_chars%20%3E%3D%203%20%7C%20project%20_time%2C%20uri%2C%20special_chars%2C%20id%2C%20status%2C%20method%20%7C%20sort%20by%20special_chars%20desc%20%7C%20limit%2010%22%7D)
