...
| [trim_start()](<#trim-start()>)                         | Removes leading match of the specified regular cutset.                                                                 |
...
- To decode base64 strings to UTF-8 strings, see [base64_decode_tostring()](</apl/scalar-functions/string-functions#base64-decode-tostring()>)
...
- To encode strings to base64 string, see [base64_encode_tostring()](</apl/scalar-functions/string-functions#base64-encode-tostring()>)
...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/explorer?initForm=%7B%22apl%22%3A%22%5B'github-issues-event'%5D%5Cn%7C%20extend%20replaced_string%20%3D%20replace_string%28'creator'%2C%20'github'%2C%20'replace'%29%22%7D)
