...
| [replace()](#replace)                               | Replace all regular expression matches with another string.                                                                             |
| [replace_regex()](#replace-regex)                   | Replaces all regular expression matches with another string.                                                                            |
