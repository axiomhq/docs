...
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| [base64_decode_toarray](/apl/scalar-functions/string-functions/base64-decode-toarray) | Decodes an array of base64 strings to UTF-8 strings.                                                                                         |
| [base64_decode_tostring](#base64-decode-tostring) | Decodes a base64 string to a UTF-8 string.                                                                                 |
| [base64_encode_fromarray](/apl/scalar-functions/string-functions/base64-encode-fromarray) | Encodes an array of strings as base64 strings.                                                                                         |
