...
sidebarTitle: Pair
keywords: ['axiom documentation', 'documentation', 'axiom', 'pair', 'parse_pair']
---
...
| ------------------------------------------------------- | ------------------------------------------------------------------------------- |
| [find_pair](/apl/scalar-functions/pair-functions/find-pair)                             | Searches an array of key-value pairs and finds the first pair that matches the specified key and value patterns. |
