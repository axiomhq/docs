...
```kusto
['otel-demo-traces']
| extend status = column_ifexists('status_code', '100')
| project _time, trace_id, span_id, status
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D%20%7C%20extend%20status%20%3D%20column_ifexists('status_code'%2C%20'100')%20%7C%20project%20_time%2C%20trace_id%2C%20span_id%2C%20status%22%7D)
