...
| [bag_has_key](/apl/scalar-functions/array-functions/bag-has-key)                 | Calculates the sum of elements in a dynamic array.                                                                  |
| [bag_keys](/apl/scalar-functions/array-functions/bag-keys)                 | Calculates the sum of elements in a dynamic array.                                                                  |
| [bag_merge](/apl/scalar-functions/array-functions/bag-merge)                 | Calculates the sum of elements in a dynamic array.                                                                  |
| [bag_pack](/apl/scalar-functions/array-functions/bag-pack)                 | Calculates the sum of elements in a dynamic array.                                                                  |
