...
- [array_index_of](/apl/array-functions/array_index_of-function): Returns the index of a specified element within an array.
- [array_slice](/apl/array-functions/array_slice-function): Extracts a portion of an array based on start and length values.
- [make_list](/apl/aggregation-functions/make_list-function): Aggregates values into an array, which can then be reversed or otherwise manipulated.