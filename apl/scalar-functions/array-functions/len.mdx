...
\[Run in Playground]\([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D) %7C extend uri\_length%20%3D%20len(uri) %7C where uri\_length%20%3E%20100 %7C project \_time%2C id%2C uri%2C uri\_length%22%7D)
...
\[Run in Playground]\([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D) %7C extend trace\_id\_length%20%3D%20len(trace\_id) %7C summarize count()%20by%20trace\_id\_length%22%7D)
...
\[Run in Playground]\([https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'sample-http-logs'%5D) %7C extend method\_length%20%3D%20len(method) %7C where method\_length%20%3C%203 %7C project \_time%2C id%2C method%2C method\_length%22%7D)
...
* [array\_length](/apl/array-functions/array_length): Returns the number of elements in an array. Use this when working specifically with arrays.
