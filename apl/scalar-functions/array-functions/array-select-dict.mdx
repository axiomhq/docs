...
- [**array_contains**](/apl/array-functions/array_contains-function): Checks if an array contains a specified value.
- [**array_concat**](/apl/array-functions/array_concat-function): Concatenates two arrays.
- [**array_index_of**](/apl/array-functions/array_index_of-function): Finds the index of the first occurrence of a value in an array.
- [**mvexpand**](/apl/array-functions/mvexpand-function): Expands array elements into multiple rows.