...
| trace\_id | spans                            | sorted                           | slowest\_2                    |
| --------- | -------------------------------- | -------------------------------- | ----------------------------- |
...
* [array\_slice](/apl/array-functions/array_slice): Returns a subarray like `array_extract`, but supports negative indexing.
* [array\_length](/apl/array-functions/array_length): Returns the number of elements in an array. Useful before applying `array_extract`.
* [array\_concat](/apl/array-functions/array_concat): Joins arrays end-to-end. Use before or after slicing arrays with `array_extract`.
* [array\_index\_of](/apl/array-functions/array_index_of): Finds the position of an element in an array, which can help set the `startIndex` for `array_extract`.
* [sort\_array](/apl/array-functions/sort_array): Sorts array elements before applying `array_extract` to get top or bottom slices.
