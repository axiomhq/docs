...
| extend is_1s = series_equals(durations, 1000)
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D%20%7C%20summarize%20durations%20%3D%20make_list(duration)%20by%20%5B'service.name'%5D%20%7C%20extend%20is_1s%20%3D%20series_equals(durations%2C%201000)%22%7D)

**Output**

| service.name          | durations                | is_1s              |
| --------------------- | ------------------------ | ------------------ |
| frontend              | [800ms, 1000ms, 1200ms] | [false, true, false] |
| productcatalogservice | [1000ms, 1000ms, 900ms] | [true, true, false] |
