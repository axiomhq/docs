...
| extend stats_array = series_stats(status_codes)
| project ['service.name'],
    min_status = stats_array[0],
    min_position = stats_array[1],
    max_status = stats_array[2],
    max_position = stats_array[3],
    avg_status = stats_array[4]
| take 5
```

[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D%20%7C%20where%20isnotnull(%5B'attributes.http.status_code'%5D)%20%7C%20summarize%20status_codes%20%3D%20make_list(tolong(%5B'attributes.http.status_code'%5D))%20by%20%5B'service.name'%5D%20%7C%20extend%20stats_array%20%3D%20series_stats(status_codes)%20%7C%20project%20%5B'service.name'%5D%2C%20min_status%20%3D%20stats_array%5B0%5D%2C%20min_position%20%3D%20stats_array%5B1%5D%2C%20max_status%20%3D%20stats_array%5B2%5D%2C%20max_position%20%3D%20stats_array%5B3%5D%2C%20avg_status%20%3D%20stats_array%5B4%5D%20%7C%20take%205%22%7D)
