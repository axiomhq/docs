...
[Run in Playground](https://play.axiom.co/axiom-play-qf1k/query?initForm=%7B%22apl%22%3A%22%5B'otel-demo-traces'%5D%20%7C%20make-series%20span_durations%20%3D%20avg(duration)%20on%20_time%20step%205m%20by%20%5B'service.name'%5D%20%7C%20extend%20shifted%20%3D%20series_shift(span_durations%2C%201)%20%7C%20extend%20decreasing%20%3D%20series_less(span_durations%2C%20shifted)%22%7D)
