...
- [**ipv4_compare**](/apl/scalar-functions/ip-functions/ipv4-compare): Compares two IP addresses lexicographically.
- [**ipv4_is_in_range**](/apl/scalar-functions/ip-functions/ipv4-is-in-range): Checks if an IP address is within a specified range.
- [**ipv4_is_private**](/apl/scalar-functions/ip-functions/ipv4-is-private): Checks if an IP address is private. Useful for identifying internal traffic.