...
- [**startswith**](/apl/string-functions/startswith-function): Determines if a string starts with a specified substring.
- [**in**](/apl/scalar-functions/in-function): Checks if a value exists within a specified list.
- [**matches_regex**](/apl/string-functions/matches_regex-function): Matches strings against a regular expression.
