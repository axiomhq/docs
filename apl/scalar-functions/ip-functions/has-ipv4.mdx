...
- [**has_any_ipv4**](/apl/string-functions/has-any-ipv4-function): Search for multiple IPv4 addresses in a single query.
- [**has_ipv4_prefix**](/apl/string-functions/has-ipv4-prefix-function): Check if a text contains an IPv4 address with a specific prefix.
- [**extract_ipv4**](/apl/string-functions/extract-ipv4-function): Extract IPv4 addresses from a given text.
- [**parse_ipv4**](/apl/string-functions/parse-ipv4-function): Validate and parse IPv4 addresses from text.
- [**is_ipv4**](/apl/string-functions/is-ipv4-function): Determine if a string is a valid IPv4 address.