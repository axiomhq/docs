...
- [**format_ipv6**](/apl/network-functions/format_ipv6-function): Converts numeric IPv6 addresses into standard textual representation.
- [**parse_ipv4**](/apl/network-functions/parse_ipv4-function): Converts a dotted-decimal IPv4 address into a numeric representation.
- [**cidr_match**](/apl/network-functions/cidr_match-function): Checks whether an IP address falls within a CIDR range.
- [**ip_version**](/apl/network-functions/ip_version-function): Determines the IP version (IPv4 or IPv6) of an address.
- [**parse_ipv6**](/apl/network-functions/parse_ipv6-function): Converts textual IPv6 addresses into their numeric representation.