...
- [**has_ipv4**](/apl/scalar-functions/ip-functions/has-ipv4): Determines if a string contains a valid IPv4 address. Use to validate IP addresses before applying `has_ipv4_prefix`.
- [**parse_ipv4**](/apl/scalar-functions/ip-functions/parse-ipv4): Parses and converts an IPv4 address into a structured type for advanced operations.
