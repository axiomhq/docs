...
- [**has_ipv4**](/apl/string-functions/has_ipv4-function): Checks if a single IPv4 address is present in a string column.
- [**has_any_ipv6**](/apl/string-functions/has_any_ipv6-function): Matches any IPv6 address in a string column with a list of IPv6 addresses or ranges.
- [**cidr_match**](/apl/string-functions/cidr_match-function): Checks if an IP address falls within a specific CIDR range.