...
To access the properties of nested maps, use dot notation, index notation, or a mix of the two. If you use index notation for an entity, enclose the entity name in quotations marks (`'` or `"`) and square brackets (`[]`). For example:
