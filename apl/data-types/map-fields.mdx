...
Map fields are particularly useful for handling nested data structures, such as data from logfmt format or other key-value formats where the structure may be unpredictable.
...
1. In the top right of the fields list, click <Icon icon="ellipsis-vertical" iconType="solid"/> **More > Create map field**.
