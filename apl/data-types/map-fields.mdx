...
The drawback of map fields are the following:
...
If the entity names have spaces (` `), dots (`.`), or dashes (`-`) as in this example, use the syntax `['MAP.FIELD.NAME']['MAP.FIELD']`. For more information, see [Entity names](/apl/entities/entity-names#quote-identifiers).

To access the properties of nested maps, use dot notation. For example `where ['map.field'].property1.property2 == 14`.
