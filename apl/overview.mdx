...
Logs and traces are discrete events: each row is a self-contained record with an arbitrary schema. The language designed for this type of data is APL (Axiom Processing Language), which excels at slicing, extending, and summarizing that kind of data.
