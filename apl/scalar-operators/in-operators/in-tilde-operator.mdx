...
| ---------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Expression | scalar            | Yes      | The expression whose value to check for membership (case-insensitive).                                                                                             |
| Value      | scalar or tabular | Yes      | A scalar value or tabular expression that specifies the set of values to match against. If a tabular expression has multiple columns, the first column is used. The search considers up to 1,000,000 distinct values. |
