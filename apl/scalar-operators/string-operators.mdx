...
The table summarizes the string operators available in APL. For set membership operators (`in`, `!in`, `in~`, `!in~`), see [Set membership operators](/apl/scalar-operators/in-operators).
...
| !has_any       | RHS doesn't have any whole term in LHS  | No                 | `"North America" !has_any ("Asia", "Europe")`   |
| has_any_cs     | RHS has any whole term in LHS           | Yes                | `"North America" has_any_cs ("America", "Europe")` |
| !has_any_cs    | RHS doesn't have any whole term in LHS  | Yes                | `"North America" !has_any_cs ("america", "europe")` |
...
"North America" !has_any ("asia", "europe") // True
