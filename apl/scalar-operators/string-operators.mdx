...
sidebarTitle: String
tags:
  ['axiom documentation', 'documentation', 'axiom', 'string operators', 'contains', '!contains', 'contains_cs', 'endswith', 'in', 'has', 'startswith', 'matches regex']
---
...
Below is the list of string operators we support in Axiom Processing Language.
...
| **in**             | Equals one of the elements              | Yes                | `abc` in ("123", "345", "abc")         |
| **!in**            | Doesn't equal any of the elements       | Yes                | "bca" !in ("123", "345", "abc")        |
| **in~**            | Equals one of the elements              | No                 | "abc" in~ ("123", "345", "ABC")        |
| **!in~**           | Doesn't equal any of the elements       | No                 | "bca" !in~ ("123", "345", "ABC")       |
...
|------------|------------------|----------|--------------------------------------------------------------------------------------------------|
| Field      | string           | ✓        | The field that filters the events                                                                |
| Expression | scalar or tabular| ✓        | An expression to search for. The first field is used if the value of the expression has multiple fields |
