...
- Handle missing or invalid data: Consider how to handle scenarios where the parsing pattern doesn’t match or the extracted values do not conform to the expected types. Use the relaxed mode or provide default values to handle such cases.
