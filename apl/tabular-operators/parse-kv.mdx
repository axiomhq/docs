...
| `pair_delimiter` | A character or string that separates key-value pairs (for example, `;` or `,`). |
| `kv_delimiter`   | A character or string that separates keys and values (for example, `=` or `:`). |
