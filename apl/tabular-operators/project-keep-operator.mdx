...
| Time                | Status | URI                 | Method | Duration (ms) |
|---------------------|--------|---------------------|--------|---------------|
...
For OpenTelemetry trace analysis, you might want to focus on key tracing details such as service names and trace IDs.
...
| Time                | Trace ID     | Span ID     | Service Name   | Duration |
|---------------------|--------------|-------------|----------------|----------|
...
| Time                | ID        | Status | URI           | City         | Country |
|---------------------|-----------|--------|---------------|--------------|---------|
...
The syntax for wildcard can be either `data*` or `['data.fo']*`.
