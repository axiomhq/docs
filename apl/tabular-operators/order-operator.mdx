...
| Time               | Req_duration_ms | ID     | Status | URI                    | Method | Geo.city | Geo.country |
|---------------------|-----------------|--------|--------|------------------------|--------|----------|-------------|
...
| Time               | Duration | Span_id    | Trace_id  | Service.name       | Kind   | Status_code |
|---------------------|----------|------------|-----------|--------------------|--------|-------------|
