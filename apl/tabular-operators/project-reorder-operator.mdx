...
```kusto
| project-reorder column1 [asc | desc | granny-asc | granny-desc], column2 [asc | desc | granny-asc | granny-desc], ...
```

### Parameters

- `column1, column2, ...`: The names of the columns in the order you want them to appear in the result set.
