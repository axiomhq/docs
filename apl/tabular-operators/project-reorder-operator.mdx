...
```kusto
| project-reorder FieldName1OrWildcard [asc|desc|granny-asc|granny-desc], FieldName2OrWildcard [direction], ...
```
...
| [direction]           | **string** |  Optional. Specifies the sort order for the reordered fields. Can be one of: `asc`, `desc`, `granny-asc`, or `granny-desc`.|
