...
- `ProportionOfRows`: A float greater than 0 and less than 1 that specifies the proportion of rows to return from the dataset. The rows are selected randomly.
