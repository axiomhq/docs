...
```kusto
externaldata (_time: datetime, method: string, status: string, ['geo.city']: string, ['geo.country']: string, id: string)
["https://raw.githubusercontent.com/axiomhq/docs/3e42e6802ddde93176770397bf9483580f74b62e/doc-assets/files/example-event-data.csv"]
