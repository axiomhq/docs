...
| [parse-kv](/apl/tabular-operators/parse-kv)                     | Returns a dataset where key-value pairs are extracted from a specified field.                                                                  |
| [parse-where](/apl/tabular-operators/parse-where)                     | Returns a dataset where the specified field is parsed according to the specified pattern.                                                                  |
