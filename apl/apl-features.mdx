...
| SQL function           | [format_apl](/apl/scalar-functions/sql-functions/format-apl)                                     | Converts parsed APL query structure back into APL query string. |
...
| SQL function           | [parse_apl](/apl/scalar-functions/sql-functions/parse-apl)                                       | Parses APL query strings into structured dynamic objects. |
