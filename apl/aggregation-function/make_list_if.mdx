...
- [`make_list`](/apl/aggregation-function/make_list): Aggregates all values into a list without any conditions. Use `make_list` when you don’t need to filter the values based on a condition.
