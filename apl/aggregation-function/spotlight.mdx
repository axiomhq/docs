...
<Note>
The wildcard `*` is useful to analyze all fields in the current row, but it increases query complexity and decreases performance. Specify only relevant fields when possible. For more information, see [Wildcards](/apl/reference/wildcards).
</Note>
