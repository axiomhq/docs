...
- **`median`**: The `median` function returns the middle value in a sorted dataset, which is the 50th percentile. Use `percentile` if you need other percentiles beyond the median.
