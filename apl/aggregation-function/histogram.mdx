...
This query groups the `req_duration_ms` into 100 ms intervals and counts the occurrences in each bin, helping identify how frequently different response times occur.
