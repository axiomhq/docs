...
- **`summarize`**: General-purpose aggregation that combines multiple rows into a single result, often used for counts, sums, or averages. Use when you need numeric aggregation.
