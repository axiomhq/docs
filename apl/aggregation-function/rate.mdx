...
In this example, the `rate` aggregation calculates the rate of HTTP request duration per second, which can be useful to detect an increase in malicious requests.
